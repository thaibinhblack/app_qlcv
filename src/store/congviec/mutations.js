export default {
    ...
    SET_CONG_VIEC_PC(state,list_cong_viec_phan_cong){
        state.list_cong_viec_phan_cong = list_cong_viec_phan_cong
    },
    SET_CONGVIEC_TRONG_NGAY(state,list_congviec_trong_ngay)
    {
        state.list_congviec_trong_ngay = list_congviec_trong_ngay
    },
    ...
    SEARCH_TASK_PC(state,id_task)
    {
        state.task_edit = state.list_cong_viec_phan_cong.filter((value,index,array) => {
            return array[index].id_cv_da == id_task
        })[0]
    },
    FILTER_CONGVIEC()
