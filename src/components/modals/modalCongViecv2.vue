      ...
      <div class="row">
        <div class="col-sm-12 col-md-6">
          ...
          <div class="form-group row">        
            ...
            <div class="col-sm-8">
              <b-field>
                <b-select v-model="cong_viec.type_cv" :disabled="cong_viec.trang_thai_td == 1 || cong_viec.trang_thai_td == 2 ?  true : false">
          ...
          <div class="form-group row">        
            ...
            <div class="col-sm-8">
              <b-input :disabled="cong_viec.trang_thai_td == 1 || cong_viec.trang_thai_td == 2 ?  true : false" type="text" placeholder="Người yêu cầu" v-model="cong_viec.nguoi_yeu_cau"></b-input>
            </div>
          </div>
          <div class="form-group row">        
            <label for="inputPassword3" class="col-sm-4 col-form-label" >Tên công việc <span class="color-warning">(*)</span></label>
            <div class="col-sm-8">
              <b-input :disabled="cong_viec.trang_thai_td == 1 || cong_viec.trang_thai_td == 2 ?  true : false" type="text" v-model="cong_viec.ten_cv" required placeholder="Tên công việc" ></b-input>
            </div>
          </div>
          <div class="form-group row">        
           ...
           <div class="form-group row">        
            ...
            <div class="col-sm-8">
              ...
              maxlength="255" placeholder="Ghi chú" :disabled="cong_viec.trang_thai_td == 1 || cong_viec.trang_thai_td == 2 ?  true : false" v-model="cong_viec.ghi_chu"   ></b-input>
            </div>
          </div>
          <div class="form-group row">        
          ...
          <div class="form-group row">        
            <label for="inputPassword3"  class="col-sm-4 col-form-label" >Cần theo dõi</label>
            <div class="col-sm-8">
              <b-checkbox @input="change_flow()" v-model="flow" native-value="1" value="1"></b-checkbox>
            </div>
          </div>
          <div class="form-group row">        
        ...
        <div class="col-sm-12 col-md-6">
            <div class="form-group row">        
              ...
              <div class="col-sm-8">
                <b-field >
                  <b-input type="date" :disabled="cong_viec.trang_thai_td == 1 || cong_viec.trang_thai_td == 2 ?  true : false" style="width: 100%;"  v-model="cong_viec.ngay_tiep_nhan"></b-input>
            ...
            <div class="form-group row">        
              ...
              <div class="col-sm-8 group-time" :class="error.time_nhan_viec">
                <input min="4" max="5" class="item-time" type="text" v-model="cong_viec.time_nv"  @change="convert_time(1)" />
                <b-input class="item-time"  type="date" :disabled="cong_viec.trang_thai_td == 1 || cong_viec.trang_thai_td == 2 ?  true : false" style="width: 100%;"  v-model="cong_viec.ngay_giao_viec"></b-input>
            ...
            <div class="form-group row">        
                <label for="inputPassword3" class="col-sm-4 col-form-label" >Ngày hoàn thành </label>
                 <div class="col-sm-8 group-time" :class="error.time_hoan_thanh">
                    <input min="4" max="5" class="item-time" type="text" v-model="cong_viec.time_ht" @change="convert_time(2)" />
                    <b-input class="item-time"  type="date" :disabled="cong_viec.trang_thai_td == 1 || cong_viec.trang_thai_td == 2 ?  true : false" style="width: 100%;"  v-model="cong_viec.ngay_hoan_thanh"></b-input>
            ...
            <div class="form-group row">        
                ...
                <div class="col-sm-8">
                  <b-field >
                     <b-input type="date" :disabled="cong_viec.trang_thai_td == 1 || cong_viec.trang_thai_td == 2 ?  true : false"  style="width: 100%;"  v-model="cong_viec.ngay_cam_ket"></b-input>
        ...
        <!-- {{Object.entries(this.getTaskEdit)}} -->
          ...
          <div class="col-sm-9" v-else>
            <!-- {{Object.entries(this.getTaskEdit).length === 0}} -->
              <button type="submit" v-if="Object.entries(this.getTaskEdit).length <= 6"  class="btn btn-primary btn-form">Lưu lại</button>
...
export default {
    ...
    watch:
    {
      selected_user_giaoviec(user)
      {
        this.cong_viec.id_telegram_giaoviec = user.id_telegram
        this.cong_viec.notify_telegram = user.notify_telegram
      },
    ...
    methods:
    {
      ...
      convert_time(check)
      {
          if(check == 1)
          {
             ...
             if((this.cong_viec.time_nv).length == 4 && (this.cong_viec.time_nv).match(/[0-9]/g).length == 4)
              {
                
                this.cong_viec.time_nv = (this.cong_viec.time_nv).slice(0,2) + ':' + (this.cong_viec.time_nv).slice(2,4)
                 console.log(this.cong_viec.time_nv)
                this.error.time_nhan_viec = ''
              }
              else{
                if((this.cong_viec.time_nv).length > 5 || (this.cong_viec.time_nv).length  < 4)
                {

                  this.$buefy.notification.open({
                          duration: 1500,
                          message: 'Lỗi, không phải chuỗi thời gian!',
                          position: 'is-bottom-left',
                          type: 'is-warning',
                          hasIcon: true
                      })
                      this.error.time_nhan_viec = 'active'
                }
                else
                {
                  if((this.cong_viec.time_ht).slice(2,3) != ':')
                  {
                    this.$buefy.notification.open({
                      duration: 1500,
                      message: 'Lỗi, bạn nhập đây không phải là số!',
                      position: 'is-bottom-left',
                      type: 'is-warning',
                      hasIcon: true
                    })
          ...
          else
          {
             ...
             if((this.cong_viec.time_ht).length == 4 && (this.cong_viec.time_ht).match(/[0-9]/g).length == 4)
              {
                this.cong_viec.time_ht = (this.cong_viec.time_ht).slice(0,2) + ':' + (this.cong_viec.time_ht).slice(2,4)
                this.error.time_hoan_thanh = ''
              }
              else{
                if(((this.cong_viec.time_ht).length > 5 || (this.cong_viec.time_ht).length  < 4 ))
                {
                  ...
                  this.$buefy.notification.open({
                      ...
                      this.error.time_hoan_thanh = 'active'
                }
                else
                {
                  if((this.cong_viec.time_ht).slice(2,3) != ':')
      ...
      api_cong_viec()
      {
          ...
          this.$store.dispatch('updateCongViec',this.cong_viec).then((response) => {
              ...
              if(response.success == true){
                ...
                if(this.selected_du_an_kh[0])
                {
                  ...
                  console.log('array_du_an',array_du_an)
        ...
        else
        {
           ...
           this.cong_viec.nguoi_nhap = this.my_info.id_nd
            ...
            if(array_du_an.length > 1)
            {
              this.cong_viec.gio_thuc_hien = parseFloat(this.gio_thuc_hien  / array_du_an.length).toFixed(2)
    ...
    created()
    {
        ...
        if(Object.entries(this.getTaskEdit).length > 6)
        {
          ...
          if(this.cong_viec.trang_thai_td == 1 || this.cong_viec.trang_thai_td == 2)
          {
            this.cong_viec.ngay_tham_dinh = new Date().toISOString().substr(0,10)
          }
          console.log('cong_viec',this.cong_viec)
          this.cong_viec.time_nv = this.cong_viec.tgian_nhan_viec.slice(11,16)
          this.cong_viec.time_ht = this.cong_viec.tgian_hoan_thanh.slice(11,16)
          this.cong_viec.tien_do = parseInt(this.getTaskEdit.tien_do)
          this.cong_viec.time_nhan_viec = this.cong_viec.time_nhan_viec != undefined ? JSON.parse(this.cong_viec.time_nhan_viec) : {HH: '07', mm: '00', ss: '00'}
          this.cong_viec.time_hoan_thanh = this.cong_viec.time_hoan_thanh != undefined ?  JSON.parse(this.cong_viec.time_hoan_thanh) : {HH: '07', mm: '00', ss: '00'}
          this.api_files()
        }
        else{
          this.axios.get(this.$store.state.config.API_URL + 'token?api_token='+this.$cookies.get('token')).then((response) => {
