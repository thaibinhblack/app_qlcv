...
<div id="page-ds-phong-ban">
    <div class="row">
        <div class="col-sm-12 col-md-8 col-lg-7" style="margin:auto">
            <div class="card">
                ...
                <form-group  :trung_tams="trung_tams" @create_pb="create_phong_ban = $event" :phong_ban_edit="phong_ban_edit" />
            </div>
        </div>
    </div>
    ...
    <div class="table-phong-ban" style="margin-top: 50px" oncontextmenu="return false" onselectstart="return false" ondragstart="return false">
        ...
        <div class="popup" :style="positon" :class="{active: popup_active}">
            <ul>
                <li @click="updatePhongBan()">Xem</li>
                <li>Sửa</li>
                <li>Xóa</li>
            </ul>
        </div>
...
export default {
    ...
    data()
    {
        return {
            ...
            columns: [
                ...
                {text: 'ID_TT', datafield: 'id_tt', columntype: 'hidden', hidden: true},
            ],
            popup_active: false,
    ...
    methods: {
        ...
        onRowclick: function (event) {
            ...
            console.log(this.phong_ban_edit)
        },
        updatePhongBan()
        {
            this.
