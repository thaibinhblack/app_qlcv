                ...
                <div class="edit-user card">
                    ...
                    <div class="columns" style="margin:0">
                        <div class="form-user column auto" >
                                <form-user :trung_tam_selected="trung_tam_selected" :trung_tams="trung_tams" :user_edit="user_edit" :update="update" :groups="groups" @createUser="create_user = $event" />
                        </div>
                    </div>
                </div>
           </div>
