            ...
            <div class="col-md-10">
                ...
                <div class="card card-rule">
                    ...
                    <div class="row" style="margin:7px 0" v-for="(function_rule, index) in functions" :key="index">
                        ...
                        <div class="col-sm-2 col-md-1 text-rule">
                             <div class="field">
                                <b-checkbox v-model="functions_check_rule[index]" :native-value="function_rule.id_cn +'.' + 2"></b-checkbox>
                            </div>
                        </div>
                        <div class="col-sm-2 col-md-1 text-rule">
                             <div class="field">
                                <b-checkbox :disabled="function_rule.id_cn == 1" v-model="functions_check_rule[index]" :native-value="function_rule.id_cn +'.' + 3"></b-checkbox>
                            </div>
                        </div>
                        <div class="col-sm-2 col-md-1 text-rule">
                             <div class="field">
                                <b-checkbox v-model="functions_check_rule[index]" :native-value="function_rule.id_cn +'.' + 4"></b-checkbox>
                            </div>
                        </div>  
                        <div class="col-sm-2 col-md-1 text-rule">
                             <div class="field">
                                <b-checkbox v-model="functions_check_rule[index]" :native-value="function_rule.id_cn +'.' + 5"></b-checkbox>
                            </div>
                        </div>  
                    </div>
                    <div class="row">
