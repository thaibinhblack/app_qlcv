    ...
    <section>
         ...
         <b-table
            ...
            <template slot-scope="props">
                <b-table-column field="ID_USER" label="ID_USER" width="40" :visible=false">
                    {{props.row.ID_USER}}
                </b-table-column>
                ...
                <b-table-column searchable field="USERNAME" label="Username" width="100" :visible="columnsVisible['USERNAME'].display">
                    {{props.row.USERNAME}}
                </b-table-column>
                <b-table-column  searchable field="EMAIL" label="Email" width="100" :visible="columnsVisible['EMAIL'].display" >
                    {{props.row.EMAIL}}
                </b-table-column>
