        ...
        api_function_rule($id)
        {
            this.axios.get(this.$store.state.config.API_URL + 'function_rule/'+$id).then((response) => {
                ...
                for (let index = 0; index < response.data.results.length; index++) {
                    ...
                    object["VIEW"].push(response.data.results[index].FUNCTION_VIEW)
                    object["CREATE"].push(response.data.results[index].FUNCTION_CREATE)
                    object["EDIT"].push(response.data.results[index].FUNCTION_EDIT)
                    object["DELETE"].push(response.data.results[index].FUNCTION_DELETE)
