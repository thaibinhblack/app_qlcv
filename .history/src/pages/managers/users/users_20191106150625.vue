           ...
           <div class="columns" style="margin:0">
               <div class="form-user column is-8 auto" style="margin:auto;padding: 50px 0;">
                    <form action="">
                        <b-field  label=""  >
                            <span>Username</span>
                            <b-input v-model="user.USERNAME" icon="account" placeholder="username" required></b-input>
                        </b-field >
                        <b-field  label="Password" >
                            <b-input type="password" v-model="user.PASSWORD" icon="key" password-reveal required ></b-input>
                        </b-field >
                        <b-field  label="Email" >
                            <b-input type="email" maxlength="50" v-model="user.EMAIL" icon="email"
                            placeholder="example@gmail.com"
                            required
                            ></b-input>
                        </b-field >
                        <b-field  label="Phone" >
                            <b-input type="phone" v-model="user.PHONE" icon="phone" maxlength="12" placeholder="09xxxxxx" required></b-input>
                        </b-field >
                        <div class="block">
                        ...
                        <b-button type="submit">Thêm mới</b-button> <b-button>Sửa</b-button>  <b-button> Xóa</b-button>
                    </form>
               </div>
           </div>
       </div>
