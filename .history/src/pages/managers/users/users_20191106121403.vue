<template>
    <div class="table-user">
            <JqxGrid :width="'99%'" ref="myGrid"  @columnclick="onColumnclick($event)" :source="dataAdapter" :columns="columns" :sortable="true" :filterable="true" :autoshowfiltericon="true" />
    ...
    export default {
        ...
        methods: {
            onColumnclick: function (event) {
                ...
                this.positon.left = event.args.originalEvent.clientX
               console.log(event)
            },
            api_user()
            {
