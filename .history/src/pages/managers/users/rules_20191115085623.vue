            ...
            <div class="col-md-10">
                ...
                <div class="card card-rule">
                    <div class="row" style="padding: 10px 0">
                        <div class="col-sm-4 col-md-6 ">Tên chức năng</div>
                        <div class="col-sm-2 col-md-1 text-rule"> Xem</div>
                        <div class="col-sm-2 col-md-2 text-rule">Thêm</div>
                    ...
                    <div class="row" style="margin:7px 0" v-for="(function_rule, index) in functions" :key="index">
                        <div class="col-sm-2 col-md-6">{{function_rule.ten_cn}}</div>
...
export default {
    ...
    methods: {
        ...
        api_user()
        {
            this.axios.get(this.$store.state.config.API_URL + 'user').then((response) => {
