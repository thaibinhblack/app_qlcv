           ...
           <div class="columns" style="margin:0">
               <div class="form-user column is-8 auto" style="margin:auto;padding: 50px 0;">
                    <b-field  label="Username" :label-position="labelPosition" >
                        <b-input v-model="user.USERNAME" icon="account" placeholder="username"></b-input>
                    </b-field >
                    ...
                    <b-field  label="Phone" :label-position="labelPosition">
                        <b-input v-model="user.PHONE" icon="phone" maxlength="12" placeholder="09xxxxxx"></b-input>
                    </b-field >
                    <div class="block">
