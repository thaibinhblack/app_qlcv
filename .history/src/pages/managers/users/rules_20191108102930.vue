        ...
        updateFunctionRule()
        {
            ...
            this.functions_check_rule.forEach((check) => {
                ...
                console.log('check',check)
                    ...
                    const function_view = check[0] ? !null : check[0] 
                    const function_edit = check[2] ? !null: check[2]
                    const function_create = check[1] ? null: check[1]
                    const function_delete = check[3] ? !null: check[3]
