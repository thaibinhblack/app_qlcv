           ...
           <div class="col-sm-12 col-md-6" style="margin:auto">
                <div class="edit-user card">
                    ...
                    <div class="columns" style="margin:0">
                        <div class="form-user column auto" style="margin:auto;padding: 50px 15px;">
                                <form-user :trung_tams="trung_tams" :user_edit="user_edit" :update="update" :groups="groups" @createUser="create_user = $event" />
                        </div>
                    </div>
                </div>
           </div>
        ...
        data: function () {
            return {
                ...
                columns: [
                    ...
                    {text: 'Giới tính', datafield: 'gt_nd', width: 50},
                ...
                if(newVal == true)
                {
                    ...
                    this.source.localdata = {
                        ...
                        datafields: [
                            ...
                            { name: 'gt_nd', type: 'checkbox' , width: 50},
