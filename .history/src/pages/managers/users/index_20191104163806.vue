    ...
    <section id="section-users">
        ...
        <b-table
            ...
            <template slot-scope="props">
                <b-table-column searchable field="ID_RULE" label="Quyền" width="100" :visible="columnsVisible['ID_RULE'].display" >
                ...
                <b-table-column field="USERNAME" searchable label="Username" width="100" :visible="columnsVisible['USERNAME'].display">
                    {{props.row.USERNAME}}
                </b-table-column>
                <b-table-column  field="EMAIL" label="Email" width="100" :visible="columnsVisible['EMAIL'].display" >
                    {{props.row.EMAIL}}
                </b-table-column>
                <b-table-column sortable field="GENDER" label="Giới tính" width="40" :visible="columnsVisible['GENDER'].display" >
                    <b-field  v-if="edit_user == props.row.ID_USER">
                        <b-select placeholder="Quyền hệ thống" v-model="props.row.GENDER">
                           <option value="0">Nam</option>
                           <option value="1">Nữ</option>
                        </b-select>
                    </b-field>
                   <div v-else>
                        <span v-if="props.row.GENDER == 0"> Nam</span>
                        <span v-else>Nữ</span>
                   </div>
                </b-table-column>
                ...
                <b-table-column sortable field="BIRTH_DAY" label="Ngày sinh" width="150" :visible="columnsVisible['BIRTH_DAY'].display" >
                    {{props.row.BIRTH_DAY}}
                </b-table-column>
                <b-table-column field="ADDRESS" label="Địa chỉ" width="150" :visible="columnsVisible['ADDRESS'].display" >
                    {{props.row.ADDRESS}}
                </b-table-column>
                <b-table-column label="Thao tác" width="150">
            ...
            <template slot="empty">
                <section class="section">
                    <div class="content has-text-grey has-text-centered">
                        ...
                        <p><b-button @click="data = data_tmp"> Không tìm thấy dữ liệu   <b-icon  icon="refresh"></b-icon> </b-button> </p>
                    </div>
                </section>
            </template>
        </b-table>
