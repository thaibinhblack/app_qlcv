        ...
        data: function () {
            return {
                ...
                columns: [
                    ...
                    {text: 'Ngày sinh', datafield: 'ngay_sinh_nd', width: 240, cellsrenderer: (index, datafield, value, defaultvalue, column, rowdata) => { 
                       return new Date(rowdata.ngay_sinh_nd).toLocaleDateString()
