        ...
        api_function_rule($id)
        {
            this.axios.get(this.$store.state.config.API_URL + 'function_rule/'+$id).then((response) => {
                ...
                for (let index = 0; index < response.data.results.length; index++) {
                    ...
                    object.push(response.data.results[index].VIEW.FUNCTION_VIEW)
                    object.push(response.data.results[index].CREATE.FUNCTION_CREATE)
                    object.push(response.data.results[index].EDIT.FUNCTION_EDIT)
                    object.push(response.data.results[index].DELETE.FUNCTION_DELETE)
