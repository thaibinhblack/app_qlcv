                ...
                <div class="card card-rule">
                    ...
                    <div class="row" style="margin:7px 0" v-for="(function_rule, index) in functions" :key="index">
                        ...
                        <div class="col-sm-2 col-md-2 text-rule"> 
                            <div class="field" >
                                <b-checkbox v-model="functions_check_rule[function_rule]"  :native-value="function_rule.ID_FUNCTION +'.'+ 1"></b-checkbox>
                            </div>
                        </div>
                        <div class="col-sm-2 col-md-2 text-rule">
                             <div class="field">
                                <b-checkbox v-model="functions_check_rule[function_rule]" :native-value="function_rule.ID_FUNCTION +'.' + 2"></b-checkbox>
                            </div>
                        </div>
                        <div class="col-sm-2 col-md-2 text-rule">
                             <div class="field">
                                <b-checkbox v-model="functions_check_rule[function_rule]" :native-value="function_rule.ID_FUNCTION +'.' + 3"></b-checkbox>
                            </div>
                        </div>
                        <div class="col-sm-2 col-md-2 text-rule">
                             <div class="field">
                                <b-checkbox v-model="functions_check_rule[function_rule]" :native-value="function_rule.ID_FUNCTION +'.' + 4"></b-checkbox>
                            </div>
                        </div>  
                    </div>
                    <div class="row">
