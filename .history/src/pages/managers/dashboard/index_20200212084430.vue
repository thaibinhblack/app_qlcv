...
export default {
    components:
    {
        ...
        'table-pie': () => import("@/components/charts/tablePie.vue")
    },
    data()
    {
        return {
...
.table-chart-pie>li {width: 50%;display: inline-block;padding: 10px 5px;border: 1px solid #e2e2e2;text-align: center}
