...
<div id="page-project">
              ...
              <div class="item-card" v-for="i in 5" :key="i">
               ...
               <div class="item-card">
                <b-navbar-item  class="item-user item-user-add">
                    ...
                    <b-button icon-left="plus" @click="isActiveModalProjects = !isActiveModalProjects"></b-button>
  ...
  <b-modal :active.sync="isActiveModalProject" :width="'900px'" :can-cancel="false">
    ...
    <modal-project :selected_project="selected_project" :du_an_selected="du_an_selected" />
  </b-modal>
</div>
</template>
<script>
