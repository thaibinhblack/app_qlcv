    ...
    <div class="row">
        <div class="col-sm-12 col-md-7 col-lg-6" style="margin:auto">
            <div class="card">
                ...
                <form-loai-cv  :update="update" :loai_cv_edit="loai_cv_edit" @clear="update = $event"/>
            </div>
        </div>
    </div>
        ...
        return {
            ...
            columns: [
                ...
                {text: 'Trạng thái', datafield: 'trang_thai', width: 240, filtertype: 'checkedlist', cellsrenderer: (index, datafield, value, defaultvalue, column, rowdata) => {
                    ...
                    return '<div style="margin: 4px;" class="jqx-left-align"> <a href="/project?id_du_an=' +  if(rowdata.trang_thai == 1)
                    {
                        return 'Đang thực hiện'
                    } + '" target="_blank">'+rowdata.ten_du_an+'</a></div>';
                    }},
