              ...
              <div class="item-card" v-for="(nv,i) in nhanvien_thamgia" :key="i">
                ...
                <div class="card card-info-user">
                      <div class="row">
                        ...
                        <div class="col-sm-8">
                          <p>{{nv.username_nd}}</p>
                          <p>Quyền: {{nv.q_xem == selected_project+'.1' ? '#xem': ''}},  {{nv.q_xem == selected_project+'.2' ? '#them': ''}}
                            , {{nv.q_xem == selected_project+'.3' ? '#sua': ''}}, {{nv.q_xem == selected_project+'.4' ? '#xoa': ''}},  {{nv.q_xem == selected_project+'.5' ? '#xuat': ''}}
                          </p>
                        </div>
                      </div>
                  </div>
