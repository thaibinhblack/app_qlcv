    ...
    <div class="col-3">
      <div class="card card-task">
        <div class="card-title">
          <h3 style="line-height:36px">Danh sách công việc 
            <b-button style="float:right"><b-icon
                icon="plus"
                size="is-small">
            </b-icon></b-button></h3>
        </div>
...
.navbar-start>a:hover {color: #333;text-decoration: none;background-color: hsla(0,0%,100%,.3)}
</style>