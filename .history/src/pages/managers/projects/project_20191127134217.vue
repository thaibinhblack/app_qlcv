...
.list-group-item {position: relative;padding: 20px 5px;margin-top: 10px;}
...
.list-action {position: absolute;right: -60px;bottom: -60px;z-index: 9999;background: #fff;display: none;}
