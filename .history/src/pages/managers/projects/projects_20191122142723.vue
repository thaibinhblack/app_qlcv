    ...
    <div class="row">
        <div class="col-sm-12 col-md-6 col-mg-5" style="margin:auto">
            <div class="add-du-an card">
                ...
                <form-du-an :loai_du_an="loai_du_an" :update="update" @clear="update = $event" :du_an_edit="du_an_edit" @create_project="reset = $event" />
            </div>
        </div>
    </div>
    ...
    data()
    {
        return {
            ...
            columns: [
                ...
                {text: 'Tên dự án', datafield: 'ten_du_an', width: 240, cellsrenderer: (index, datafield, value, defaultvalue, column, rowdata) => {
                            // let total = parseFloat(rowdata.price) * parseFloat(rowdata.quantity);
                            return '<div style="margin: 4px;" class="jqx-left-align"> <a href="/project?id_du_an=' +  rowdata.id_du_an + '">'+rowdata.ten_du_an+'</a></div>';
                            }},
