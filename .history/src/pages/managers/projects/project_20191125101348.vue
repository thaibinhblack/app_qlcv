    ...
    <div class="col-3">
      <div class="card card-task">
        ...
        <draggable class="list-group" :list="list1" group="people" @change="log" >
          <item-task  v-for="(element, index) in list1" :key="index" :task="element" />
        </draggable>
...
.list-action {position: absolute;right: -20px;bottom: -60px;z-index: 999;background: #fff;display: none;}
