    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12" style="margin:auto" v-if="getAction_projects.them == '3.2' || getAction_projects.sua == '3.3'">
            <div class="add-du-an card">
                 <p class="background">Danh mục dự án khách hàng  <b-button class="btn-minus-plus" icon-left="minus"></b-button> </p>
...
<style scoped>
.btn-minus-plus {float: right;background: transparent;color:#fff;border: none;height: 30px;;}
</style>