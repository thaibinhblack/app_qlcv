            ...
            if(newVal == true)
            {
                ...
                this.source.localdata = {
                    ...
                    datafields: [
                        ...
                        { name: 'ten_du_an' ,type: 'string',cellsrenderer: (index, datafield, value, defaultvalue, column, rowdata) => {
                            // let total = parseFloat(rowdata.price) * parseFloat(rowdata.quantity);
                            return '<div style="margin: 4px;" class="jqx-right-align">' + this.dataAdapter.formatNumber(rowdata.mo_ta_du_an, 'c2') + '</div>';
                            }
                        },
