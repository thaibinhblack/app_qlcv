...
<div id="page-projects">
    {{getAction_projects}}
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-8" style="margin:auto" v-if="getAction_projects.them == '3.2' || getAction_projects.sua == '3.3'">
            <div class="add-du-an card">
                 <p class="background">Danh mục dự án khách hàng</p>
