    ...
    <div class="row">
        <div class="col-sm-12 col-md-6 col-mg-5" style="margin:auto">
            <div class="add-du-an card">
                ...
                <form-du-an :du_an="du_an" :update="update" @clear="update = $event" :du_an_edit="du_an_edit" @create_project="reset = $event" />
            </div>
        </div>
    </div>
    ...
    data()
    {
        return {
            ...
            columns: [
                ...
                {text: 'Tên dự án khách hàng', datafield: 'ten_du_an', width: 240, cellsrenderer: (index, datafield, value, defaultvalue, column, rowdata) => {
