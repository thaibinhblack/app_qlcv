               ...
               <div class="col-sm-12 col-md-6">
                   <form @submit.prevent="api_create_customer()" class="form-rule" style="padding: 15px;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <b-input type="text" v-model="status.noi_dung_trang_thai"  placeholder="Tên trạng thái"></b-input>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <button style="margin-left:0;" type="submit"  class="btn btn-primary btn-form" style="margin-left:0" >Cập nhật</button>
                        </div>    
                </form>
               </div>
           </div>
