   ...
   <b-tabs>
       ...
       <b-tab-item label="DANH MỤC TRẠNG THÁI">
           <p class="background">Danh mục trạng thái dự án khách hàng  </p>
            <form-trang-thai-du-an :trang_thai_edit="trang_thai_edit" @update="update_table = $event"/>
            <table-trang-thai style="margin-top:15px;" @trang_thai_edit="trang_thai_edit = $event" :update="update_table" />
       </b-tab-item>
   </b-tabs>
</div>
</template>
