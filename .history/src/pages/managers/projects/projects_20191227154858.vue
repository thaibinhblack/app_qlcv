    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12" style="margin:auto" v-if="getAction_projects.them == '3.2' || getAction_projects.sua == '3.3'">
            <div class="add-du-an card" >
                 <p class="background">Danh mục dự án khách hàng  <b-button @click="toggle_form_du_an_kh()" class="btn-minus-plus" :icon-left="active_table_dakh == false ? 'minus': 'plus' "></b-button> </p>
