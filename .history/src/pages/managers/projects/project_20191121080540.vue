      ...
      <b-navbar class="menu-left" style="height:20px;padding:0">
          <template slot="start">
            <b-navbar-item href="/">
              ...
              <b-navbar-item href="#">
                  <b-icon icon="bookmarks" size="is-small"></b-icon> Dự án
              </b-navbar-item>
  ...
  <div class="row" style="margin-top: 50px;">
    <div class="col-3">
      <div class="card card-task">
        ...
        <b-field class="add-task" style="margin-top: 15px" @click="task.disabled = false">
          <div class="group-add">
            <b-icon icon="plus" size="13px;"></b-icon>
            <span style="font-size:13px;line-height:26px;margin-left:10px;">Thêm công việc mới</span>
          </div>
          <form action="">
              <b-input type="text" v-model=""  placeholder="Địa chỉ khách hàng" required></b-input>
          </form>
        </b-field>
      </div>
    </div>
