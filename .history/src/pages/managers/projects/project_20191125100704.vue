              ...
              <div class="item-card" v-for="i in 5" :key="i">
               ...
               <div class="item-card">
                <b-navbar-item  class="item-user item-user-add">
                    <b-button icon-left="plus" @click="activeAddUser = !activeAddUser"></b-button>
...
.list-action {position: absolute;right: -20px;bottom: -60px;z-index: 999;background: #fff;}
.list-action li {padding: 10px 15px;border: 1px solid #e2e2e2;border-bottom: none;}
.list-action li:last-child() {border-bottom: 1 solid #e2e2e2;cursor: pointer;}
</style>