    ...
    data()
    {
        return {
            ...
            columns: [
                ...
                {text: 'Mô tả', datafield: 'mo_ta_loai_da', width: 240},
                {text: 'Ghi chú', datafield: 'ghi_chu_loai_da', width: 240, },
                {text: 'Trạng thái', datafield: 'trang_thai_loai_da', width: 50, filtertype: 'checkedlist'},
            ...
            if(newVal == false)
            {
               this.source.localdata = {
                    ...
                    datafields: [
                        ...
                        { name: 'mo_ta_loai_da', type: 'string' },
                        { name: 'ghi_chu_loai_da' ,type: 'string'},
                        { name: 'trang_thai_loai_da', type: 'number' },
