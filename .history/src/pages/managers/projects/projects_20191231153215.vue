               ...
               <div class="col-sm-12 col-md-6">
                   <form @submit.prevent="api_create_customer()" class="form-rule" style="padding: 15px;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <b-input type="text" v-model="status.noi_dung_trang_thai"  placeholder="Tên trạng thái" required></b-input>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputPassword3" class="col-sm-4 col-form-label" >Ghi chú</label>
                            <div class="col-sm-8">
                                <b-input type="text" v-model="status.ghi_chu_trang_thai"  placeholder="Tên trạng thái" required></b-input>
                            </div>
                        </div>
                </form>
               </div>
