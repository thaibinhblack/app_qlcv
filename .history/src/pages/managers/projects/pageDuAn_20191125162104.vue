    ...
    <div class="row">
        <div class="col-sm-12 col-md-6 col-lg-5" style="margin:auto">
            <div class="add-loai-du-an card">
                ...
                <div class="card">
                    <form-loai-du-an :update="update" @clear="update = $event" :du_an_edit="du_an_edit" />
                </div>
            </div>
        </div>
    </div>
...
export default {
    components: {
        'form-loai-du-an': () => import('@/components/forms/formDuAn.vue'),
        JqxGrid
    },
    data()
    {
        return {
            ...
            columns: [
                ...
                {text: 'Tên loại dự án', datafield: 'ten_du_an', width: 240},
