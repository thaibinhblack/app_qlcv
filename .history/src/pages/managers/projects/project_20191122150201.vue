...
<div id="page-project">
        ...
        <draggable class="list-group" :list="list1" group="people" @change="log" >
          ...
          >
           <span>{{element.ten_cv}}</span>
            <b-button icon-left="more" class="btn-more" @click="open_task(element.id_cv)"></b-button>
          </div>
        </draggable>
  ...
  <b-modal :active.sync="isActiveModal" :width="'900px'">
      ...
      <modal-congviec :du_an="du_an" :update="update" @clear="update = $event" :selected_project="selected_project" :isActiveModal="isActiveModal" @create_cong_viec="reset = $event" />
  </b-modal>
</div>
</template>
<script>
