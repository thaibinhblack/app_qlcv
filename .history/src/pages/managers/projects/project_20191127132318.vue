      ...
      <div class="card card-task">
        ...
        <draggable class="list-group" :list="list1" group="people" @change="log" >
          <div
            ...
            :key="index"
             :class="{coder: element.id_loai_cv == 1}">
...
.list-group-item {position: relative;padding: 20px 5px;}
.list-group-item::after{content: ''; position: absolute;width: 40px;left: 5px;top: 2px;border: 1px solid #e2e2e2; background: #e2e2e2;border-radius: 5px;height: 10px;}
