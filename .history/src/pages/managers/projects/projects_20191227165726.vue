...
<div id="page-projects">
    ...
    <div class="row" v-if="update == true">
        <div class="col-sm-12 col-md-12 col-lg-12" style="margin:auto" v-if="getAction_projects.them == '3.2' || getAction_projects.sua == '3.3'">
            <div class="add-du-an card" >
                <p class="background">Thông tin khác của dự án khách hàng  <b-button @click="toggle_thongtin_du_an_kh()" class="btn-minus-plus" :icon-left="active_form_dakh == false ? 'minus': 'plus' "></b-button> </p>
                <form-thongtin-du-an :du_an_kh="du_an_kh_edit" :thong_tin="thong_tin" />
            </div>
        </div>
    </div>
