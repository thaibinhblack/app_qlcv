    ...
    <div class="col-md-7 col-lg-6">
      ...
      <b-navbar class="menu-left" style="height:20px;padding:0">
          <template slot="start">
               ...
               <b-navbar-item class="item-user" v-for="i in 5" :key="i">
                  <div class="card">
                      <div class="row">
    ...
    <div class="col-3">
      <div class="card card-task">
        ...
        <b-field style="margin-top: 15px">
            <b-input placeholder="Thêm công việc mới"
                type="text"
                icon="plus"
                v-model="task"
...
.item-user {width:40px;height:40px;border-radius:50%;background-color: hsla(0,0%,100%,.3);margin: 0 7px;}
</style>