    ...
    data()
    {
        return {
            ...
            columns: [
                ...
                {text: 'Màu loại công việc', datafield: 'color_status', width: 50, cellsrenderer: (index, datafield, value, defaultvalue, column, rowdata) => { 
                    return '<div class="color" style="width:20px;height:20px;background:'+rowdata.color_status+';margin:auto;margin-top:10px;"></div>'
                }},
