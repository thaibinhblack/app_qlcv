...
export default {
    ...
    data()
    {
        return {
            ...
            list1: this.getCongViecByStatus1,
            list2: this.getCongViecByStatus2,
            list3: this.getCongViecByStatus3,
            list4: this.getCongViecByStatus4
        }
    },
    computed:
    {
        ...mapGetters(["getTaskEdit", "getTaskEdit", "getCongViecByStatus1", "getCongViecByStatus2", "getCongViecByStatus3",
         "getCongViecByStatus4", "LIST_DUAN", "LIST_DUAN_KH"])
    },
    watch:{
        getTaskEdit(val)
        {
