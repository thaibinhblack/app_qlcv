          ...
          <!-- {{setting_modal}}  -->
            <div class="header header-datalist">
                ...
                <ul class="list-action-data top">
                    ...
                    <li><b-button :disabled="checkedRows.length > 0 ? false : true" class="btn btn-add" @click='$store.dispatch("sendThamDinh",{
                      list_cv: checkedRows,
                      tham_dinh: filter_tham_dinh})' >{{filter_tham_dinh == 0 ? 'Gửi thẩm định' : 'Hủy thẩm định'}}</b-button></li>
                    <li>
                      <b-field>
                ...
                <ul class="list-action-data">
                   <li>
                    ...
                    <li>
                      <b-button style="margin-bottom: 5px;vertical-align: unset !importtant;" icon-left="arrow-right"></b-button>
                    </li>
                </ul>
