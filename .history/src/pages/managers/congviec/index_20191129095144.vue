            ...
            <div class="card card-task" :class="{not: zoom == 'col-12'}">
                ...
                <draggable class="list-group" :list="list1" group="people"  >
                    ...
                    <div
                        ...
                        :key="index"
                        :class="{coder: element.id_loai_cv == 1, support: element.id_loai_cv == 3, cv_kh: element.type_cv == true, error: new Date(element.ngay_hoan_thnh).getDate() - new Date().getDate()  <= 1}">
