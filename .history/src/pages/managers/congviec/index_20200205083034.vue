...
<div id="page-project" class="layout-task">
    ...
    <b-modal :active.sync="isModalTime" :width="'500px'" :can-cancel="false">
        <div class="card" >
            <p class="background">Thời gian công việc  <b-button icon-left="close" class="btn btn-close btn-form" ></b-button>   </p>
...
.btn-close {background: transparent !important;color: #fff;float: right}
</style>