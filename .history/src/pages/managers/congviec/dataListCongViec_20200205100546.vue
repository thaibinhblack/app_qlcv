             ...
             <b-table
                :data="getCongViec">
                 <template slot-scope="props">
                    ...
                    <b-table-column>
                        <b-button icon-left="pen"  @click="$store.dispatch('openTask',props.row.id_cv_da)"></b-button>
                        <b-button style="float:left;" icon-left="update"  @click="$store.dispatch('openGiaHan',element.id_cv_da)"></b-button>
                    </b-table-column>
                 </template>
            </b-table>
        </section>
