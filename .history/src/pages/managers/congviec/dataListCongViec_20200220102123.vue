                       ...
                       <template slot="header" slot-scope="{ column }">
                        ...
                        <span v-if="setting.column == 'ngay_tiep_nhan' || setting.column == 'ngay_giao_viec' || setting.column == 'ngay_hoan_thanh' || setting.column == 'ngay_cam_ket'">
                            <span v-if="setting.column == 'ngay_giao_viec' || setting.column == 'ngay_hoan_thanh'">
                              {{setting.cloumn == 'ngay_giao_viec' ? JSON.parse(props.row['time_nhan_viec']).HH :  JSON.parse(props.row['time_hoan_thanh']).HH + ':'+JSON.parse(props.row['time_hoan_thanh']).mm+':00 ,'}} {{props.row[setting.column].substr(0,10)}}
                            </span>
                        </span>
                        <span v-else>
