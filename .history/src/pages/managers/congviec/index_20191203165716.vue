                ...
                <draggable class="list-group" :list="list1" group="people"  >
                    ...
                    <div
                        ...
                        <b-button icon-left="more" class="btn-more" >
                         ...
                         <span class="ten_cv">{{element.ten_cv}}</span> <br/>
...
export default {
    ...
    watch:{
        ...
        selected_lcv(newVal)
        {
            ...
            this.list1 =  this.cong_viec.filter((value,index,array) => {
                return array[index].trang_thai == 1
            })
            this.list2 = this.cong_viec.filter((value,index,array) => {
                return array[index].trang_thai == 2
            })
                this.list3 = this.cong_viec.filter((value,index,array) => {
...
.list-filter>li {display: inline-block;margin-left: 5px;}
</style>