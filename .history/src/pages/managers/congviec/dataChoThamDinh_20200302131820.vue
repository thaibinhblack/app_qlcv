                 ...
                 <template slot-scope="props">
                    ...
                    <b-table-column label="Thời gian thẩm định" v-if="INFO_USER.id_rule > 0"> 
                      <b-field style="margin-right: 5px;float: left;">
                        <b-input style="width: 70px;" v-model="props.row.thoi_gian_tmp" type="number" @input="cal_time(props.row, props.index)" />
                      </b-field>
    ...
    methods:
    {
      cal_time(data,index)
      {
        // console.log(data,props)
          this.list_cong_viec[index].tham_dinh_tgian = parseFloat(data.thoi_gian_tmp / 60).toFixed(3)
      },
      FilterCongViecDuAn()
      {
