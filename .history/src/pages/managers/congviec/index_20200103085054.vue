...
export default {
    ...
    computed:
    {
        ...mapGetters(["getTaskEdit", "getTaskEdit", "getCongViecByStatus1", "getCongViecByStatus2", "getCongViecByStatus3",
         "getCongViecByStatus4", "LIST_DUAN", "LIST_DUAN_KH", "getCongViec"])
    },
    watch:{
        getCongViec(val)
        {
            console.log(val);
            this.list1 = this.getCongViecByStatus1
            this.list2 = this.getCongViecByStatus2
            this.list3 = this.getCongViecByStatus3
            this.list4 = this.getCongViecByStatus4
        },
        ...
        duan_selected(newVal)
        {
            ...
            this.$store.dispatch('FilterCongViecDuAn',this.time,newVal)
