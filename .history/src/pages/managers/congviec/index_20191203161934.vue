                ...
                <b-navbar-item>
                    <b-field>
                        <b-select v-model="selected_project">
                            <option value="0"> --Tất cả loại dự án khách hàng--</option>
...
export default {
    ...
    methods: {
        ...
        api_cong_viec(ID)
        {
            this.axios.get(this.$store.state.config.API_URL + 'cong-viec?api_token='+this.$cookies.get('token')+'&ID_DU_AN_KH='+ID).then((response) => {
