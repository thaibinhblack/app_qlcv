          ...
          <!-- {{setting_modal}}  -->
            <div class="header header-datalist">
                ...
                <ul class="list-action-data top">
                    ...
                    <li>
                      <b-field>
                        <b-select v-model="perPage" class="m200">
                    ...
                    <li class="filter-duan-kh">
                      <b-field style="width: 200px;">
                          <b-select v-model="filter.id_du_an" expanded @input="FilterCongViecDuAn()" class="m200" >  
                    ...
                    <li>
                      <b-field>
                          <b-select class="m200" v-model="filter.id_du_an_kh" expanded :disabled="LIST_DUAN_KH.length == 0" @input="$store.dispatch('FilterCongViec',filter)">
                    ...
                    <li>
                      <b-field>
                        <b-select class="m200" v-model="filter_trang_thai">
