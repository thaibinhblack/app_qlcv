...
.list-group {min-height: 50px;max-height: 320px;overflow: hidden;overflow-y: scroll;height: 320px;padding: 5px;}
...
.ten_cv {width: 90%;display: inline-block; font-size: 12px;}
