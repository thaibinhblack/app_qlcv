...
export default {
    ...
    methods: {
        ...
        open_task(id)
        {
            ...
            this.cong_viec_edit.ngay_tiep_nhan = this.cong_viec_edit.ngay_tiep_nhan.length > 10 || this.cong_viec_edit.ngay_tiep_nhan.length != null ? this.cong_viec_edit.ngay_tiep_nhan.slice(0,10) : null
            this.cong_viec_edit.ngay_giao_viec = this.cong_viec_edit.ngay_giao_viec.length > 10 || this.cong_viec_edit.ngay_giao_viec.length != null ? this.cong_viec_edit.ngay_giao_viec.slice(0,10) : null
            this.cong_viec_edit.ngay_hoan_thanh = this.cong_viec_edit.ngay_hoan_thanh.length > 10 || this.cong_viec_edit.ngay_hoan_thanh.length != null ? this.cong_viec_edit.ngay_hoan_thanh.slice(0,10) : null
            this.cong_viec_edit.ngay_cam_ket = this.cong_viec_edit.ngay_cam_ket.length > 10 || this.cong_viec_edit.ngay_cam_ket.length != null   ? this.cong_viec_edit.ngay_cam_ket.slice(0,10) : null
            this.update = true
