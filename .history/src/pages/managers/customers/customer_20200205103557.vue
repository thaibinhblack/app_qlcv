        ...
        return {
            dataAdapter: new jqx.dataAdapter(this.source),
                columns: [
                    ...
                    {text: 'Tình trạng KHc', datafield: 'tinh_trang_khach_hang', width: 150, cellsrenderer: (index, datafield, value, defaultvalue, column, rowdata) => { 
                    ...
                    {text: 'Ngày tạo', datafield: 'created_at', width: 240, cellsrenderer: (index, datafield, value, defaultvalue, column, rowdata) => {  
