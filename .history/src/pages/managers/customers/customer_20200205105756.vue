        ...
        return {
            dataAdapter: new jqx.dataAdapter(this.source),
                columns: [
                    ...
                    {text: 'Tình trạng KH', datafield: 'tinh_trang_khach_hang', width: 150, cellsrenderer: (index, datafield, value, defaultvalue, column, rowdata) => { 
                    // return '<div class="color" style="width:20px;height:20px;background:'+rowdata.color_status+';margin:auto;margin-top:7px;"></div>'
                        ...
                        {
                            return rowdata.tinh_trang_khach_hang + 'Đang hoạt động';
                        }
                        else if(rowdata.tinh_trang_khach_hang == 2)
                        {
                            return rowdata.tinh_trang_khach_hang + 'Đang bão trì'
                        }
                        else if(rowdata.tinh_trang_khach_hang == 3)
                        {
                            return rowdata.tinh_trang_khach_hang + 'Ngừng hoạt động'
                        }
                        else
                        {
                            return rowdata.tinh_trang_khach_hang + 'Chưa có trạng thái'
                        }
                     }},
