export default {
    ...
    UPDATE_CV_TD(state,{
        list_tham_dinh: list_tham_dinh,
        action_tham_dinh: action_tham_dinh
    })
    {
        state.list_congviec.forEach((cong_viec) => {
            list_tham_dinh.forEach((cv_td) => {
                if(cong_viec.id_cv_da == cv_td.id_cv_da)
                {
                    if(action_tham_dinh == 1)
                    {
                        cong_viec.trang_thai_td = 0
                    }
                    else
                    {
                        cong_viec.trang_thai_td = 1
                    }
                }

            })
        })
        console.log(state.list_congviec)
    }
}