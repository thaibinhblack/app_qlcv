...
export default {
    ...
    createCongViec({commit},cong_viec)
    {
        return new Promise((resolve,reject) => {
            ...
            axios.post('/api/cong-viec?api_token='+this.$cookies.get('token'),form_cong_viec).then((response) => {
    ...
    updateCongViec({commit},cong_viec)
    {
        return new Promise((resolve,reject) => {
            ...
            form_cong_viec.append("P_NGUOI_NHAP",cong_viec.nguoi_nhap)
            form_cong_viec.append("P_TYPE",cong_viec.type)
            axios.post('/api/cong-viec?api_token='+this.$cookies.get('token'),form_cong_viec).then(() => {
