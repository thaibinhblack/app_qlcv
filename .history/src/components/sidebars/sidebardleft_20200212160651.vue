<template>
    <b-menu id="sidebar">
        ...
        <b-menu-list>
            <b-menu-item>
                <template slot="label" >
                    <div class="row"  @click="$router.push('/info')">
                        <div class="col-sm-4">
                            <div class="avatar" style="width: 50px;height:50px;border-radius:50%;background:#e2e2e2;">
                                <img v-if="getUser.avatar != null" :src="$store.state.config.PUBLIC_URL + getUser.avatar"   style="width: 50px;height:50px;border-radius:50%;background:#e2e2e2;">
                            </div>
                        </div>
                        <div class="col-sm-8">
        ...
        <b-menu-list v-if="getAction_user.xem == '2.1' || getAction_user.them == '2.2' || getAction_user.sua == '2.3' || getAction_user.xoa == '2.4' || getAction_user.xuat == '2.5' ||
            ...
            <b-menu-item
                icon="settings"
                :active="active.ADMIN"
                :expanded="active.ADMIN"
                @click="active.ADMIN = !active.ADMIN">
        ...
        <b-menu-list>
            <b-menu-item
               ...
               >
                ...
                <b-menu-item icon="" label="Quản lý dự án khách hàng" @click="$router.push('/projects')"></b-menu-item>
...
<style scoped>
#sidebar {position: absolute;width:calc(100% - 15px);height: 100%;background: #e9ebee;font-size: 13px; position: fixed; width: 217px}
