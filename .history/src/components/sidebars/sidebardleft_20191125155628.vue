            ...
            <b-menu-item
               ...
               >
                <template slot="label" slot-scope="props">
                 ...
                 <b-menu-item icon="" label="Danh sách dự án" @click="$router.push('/du-an')"></b-menu-item>
                <b-menu-item icon="" label="Danh sách sự án khách hàng" @click="$router.push('/projects')"></b-menu-item>
