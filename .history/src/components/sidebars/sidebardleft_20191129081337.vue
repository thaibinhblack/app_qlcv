    ...
    <b-menu id="sidebar">
        <b-menu-list>
            <b-menu-item
                ...
                <b-menu-item v-if="getAction_rule.xem == '1.1' || getAction_rule.them == '1.2' ||" @click="$router.push('/rules')" icon="account-key" label="Quyền hệ thống"></b-menu-item>
            </b-menu-item>
        </b-menu-list>
        <b-menu-list>
            <b-menu-item
...
import { mapGetters } from 'vuex'
    export default {
        ...
        computed: {
            ...mapGetters(["getAction_user", "getAction_rule"])
        },
        watch:
        {
