    ...
    <b-menu id="sidebar">
        <b-menu-list>
            <b-menu-item
                ...
                <b-menu-item v-if="getAction_user.cn_xem == '2.1' || getAction_user.cn_them == '2.2' || getAction_user.cn_sua == '2.3' || getAction_user.cn_xoa == '2.4' || getAction_user.cn_xuat == '2.5'" icon="account" label="Users" @click="$router.push('/user')"></b-menu-item>
