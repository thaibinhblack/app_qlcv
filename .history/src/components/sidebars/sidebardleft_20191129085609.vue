        ...
        <b-menu-list>
            <b-menu-item
               ...
               >
                ...
                <b-menu-item v-if="getAction_danhmuc.xem == '5.1' || getAction_danhmuc.them == '5.2' || getAction_danhmuc.sua == '5.3' || getAction_danhmuc.xoa == '5.4' || getAction_danhmuc.xuat == '5.5'" icon="" label="Quản lý loại dự án" @click="$router.push('/loai-du-an')"></b-menu-item>
                <b-menu-item v-if="getAction_danhmuc.xem == '5.1' || getAction_danhmuc.them == '5.2' || getAction_danhmuc.sua == '5.3' || getAction_danhmuc.xoa == '5.4' || getAction_danhmuc.xuat == '5.5'" icon="" label="Quản lý dự án" @click="$router.push('/du-an')"></b-menu-item>
...
import { mapGetters } from 'vuex'
    export default {
        ...
        computed: {
            ...mapGetters(["getAction_user", "getAction_rule", "getAction_customers", "getAction_danhmuc"])
        },
        watch:
        {
