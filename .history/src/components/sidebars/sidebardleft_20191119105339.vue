    ...
    <b-menu id="sidebar">
        ...
        <b-menu-list>
            <b-menu-item
               ...
               >
                ...
                <b-menu-item icon="account" label="Danh sách sự án" @click="$router.push('/projects')"></b-menu-item>
        ...
        <b-menu-list>
            <b-menu-item
               ...
               >
                <template slot="label" slot-scope="props">
                    Quản lý danh mục trung tâm
                    <b-icon
                        class="is-pulled-right"
                        :icon="props.expanded ? 'menu-down' : 'menu-up'">
                    </b-icon>
                </template>
                <b-menu-item icon="account" label="Danh sách danh mục trung tâm" @click="$router.push('/dm-trung-tam')"></b-menu-item>
