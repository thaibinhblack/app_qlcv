        ...
        <b-menu-list>
            <b-menu-item
               ...
               >
                ...
                <b-menu-item v-if="user.id_rule > 0" icon="" label="Danh mục loại công việc" @click="$router.push('/loai-cv')"></b-menu-item>
...
import { mapGetters } from 'vuex'
    export default {
        ...
        computed: {
            ...mapGetters(["getAction_user", "getAction_rule", "getAction_customers", "getAction_danhmuc", "user"])
        },
        watch:
        {
