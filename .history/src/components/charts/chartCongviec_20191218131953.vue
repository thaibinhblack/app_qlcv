...
<script>
    ...
    export default {
        ...
        data: function () {
            return {
                dataset: [
                    { ten_loai_cv: 'London', SalesCountJan: 120, SalesRevenueJan: 123 },
                    { ten_loai_cv: 'Madrid', SalesCountJan: 190, SalesRevenueJan: 114 },
                    { ten_loai_cv: 'Munich', SalesCountJan: 201, SalesRevenueJan: 112 },
                    { ten_loai_cv: 'Amsterdam', SalesCountJan: 110, SalesRevenueJan: 98 },
                    { ten_loai_cv: 'Paris', SalesCountJan: 105, SalesRevenueJan: 93 },
                    { ten_loai_cv: 'Prague', SalesCountJan: 54, SalesRevenueJan: 100 }
                ],
                ...
                seriesGroups: [
                    {
                        ...
                        type: 'line',
                        series: [
                            { dataField: 'SalesCountJan', displayText: 'Số lượng công việc', opacity: 0.7, radius: 2, lineWidth: 2, symbolType: 'circle' },
