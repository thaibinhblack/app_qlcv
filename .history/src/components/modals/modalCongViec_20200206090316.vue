        ...
        <div class="col-sm-12 col-md-6">
          ...
          <div class="form-group row" >
              ...
              <div class="col-sm-8">
                <b-field>
                  ...
                  :multiple="Object.entries(this.getTaskEdit).length <= 5 || Object.entries(this.getTaskEdit).length === 0" :taggable="Object.entries(this.getTaskEdit).length <= 5 || Object.entries(this.getTaskEdit).length === 0"  @remove="toggleUnSelectMarket"  :show-labels="false"></multiselect>
                </b-field>
              </div>
          </div>
          <div class="form-group row">        
          ...
          <div class="form-group row">        
            ...
            <div class="col-sm-8">
              ...
              maxlength="255" placeholder="Nội dung"  v-model="cong_viec.noi_dung_cv"   ></b-input>
            </div>
          </div>
           <div class="form-group row">        
