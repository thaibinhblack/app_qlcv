...
<b-tabs @keydown.esc="close()">
            ...
            <div class="col-sm-8">
              <b-field>
                  <b-select v-model="cong_viec.type_cv"> 
                    <option value="1">KHÁCH HÀNG YÊU CẦU</option>
  ...
  <b-tab-item label="Công việc gốc" v-if="Object.entries(this.getTaskEdit).length > 5" >
...
export default {
    ...
    methods:
    {
      ...
      api_files()
      {
        if(this.cong_viec.id_cv_da != undefined)
        {
