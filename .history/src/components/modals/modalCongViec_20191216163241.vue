        ...
        <div class="col-sm-12 col-md-6">
          <div class="form-group row">        
              ...
              <div class="col-sm-8">
                ...
                {{ngay_tiep_nhan}}
                <b-field >
                  <input type="date" style="width: 100%;"  v-model="ngay_tiep_nhan">
                    <!-- <b-datepicker
                        :disabled="update"
            ...
            <div class="form-group row">        
              ...
              <div class="col-sm-8">
                <b-field >
                  <input type="date" style="width: 100%;"  v-model="ngay_giao_viec">
                    <!-- <b-datepicker
            ...
            <div class="form-group row">        
                ...
                <div class="col-sm-8">
                  ...
                  <b-field >
                    <input type="date" style="width: 100%;"  v-model="ngay_hoan_thanh">
                      <!-- <b-datepicker
                          :disabled="update"
                          :show-week-number="showWeekNumber"
                ...
                <div class="col-sm-8">
                  <b-field >
                      <!-- <b-datepicker
                       ...
                       <input type="date" style="width: 100%;"  v-model="ngay_cam_ket">
                  </b-field>
                </div>
            </div>
            <div class="form-group row">        
