      ...
      <div class="row">
          <nav class="col-sm-12" style="padding: 15px;">
            <ul class="list-file">
              ...
              <li v-for="(file,index) in LIST_FILE" :key="index"> {{file.CREATED_AT}} <a target="_blank" :href="$store.state.config.PUBLIC_URL + file.url_file"> {{file.url_file.slice(17,-2)}} </a> </li>
              <!-- <li> </li> -->
            </ul>
          </nav>
      </div>
