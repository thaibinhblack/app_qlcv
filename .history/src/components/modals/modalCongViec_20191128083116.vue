    ...
    <div class="row">
      <div class="col-sm-12 col-md-6">
        ...
        <div class="form-group row">        
          ...
          <div class="col-sm-8">
              <multiselect v-model="selected_user_giaoviec" :options="users" label="username_nd" track-by="id_nd" ></multiselect>
          </div>
        </div>
        <div class="form-group row">        
          <label for="inputPassword3"  class="col-sm-4 col-form-label" >Người tiếp nhận</label>
          <div class="col-sm-8">
             <multiselect v-model="selected_user_tiepnhan" :options="users" label="username_nd" track-by="id_nd"></multiselect>
          </div>
        </div>
      </div>
      <div class="col-sm-12 col-md-6">
    ...
    created()
    {
      this.api_loai_cv()
        ...
        if(this.cong_viec_edit.id_cv_da)
        {
          ...
          this.selected_user_giaoviec = this.users.filter((value,index,array) => {
            return array[index].id_nd == this.cong_viec_edit.nguoi_nhan_viec
          })[0]
        }
        console.log('modal',this.cong_viec,this.cong_viec_edit)
      this.selected_user_tiepnhan = this.du_an.filter((value,index,array) => {
