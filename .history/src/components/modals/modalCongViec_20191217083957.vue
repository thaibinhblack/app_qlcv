    ...
    methods:
    {
      ...
      api_users()
      {
        ...
        api_capnhat_congviec()
        {
            ...
            cong_viec.append("P_NGAY_GIAO_VIEC",this.cong_viec_edit.ngay_giao_viec)
            
            cong_viec.append("P_NGUOI_NHAN_VIEC",this.selected_user_tiepnhan.id_nd)
            cong_viec.append("P_NGAY_HOAN_THANH",this.cong_viec_edit.ngay_hoan_thanh)
            cong_viec.append("P_TIEN_DO",this.cong_viec_edit.tien_do)
            cong_viec.append("P_NGAY_CAM_KET",this.cong_viec_edit.ngay_cam_ket)
