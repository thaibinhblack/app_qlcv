          ...
          <div class="form-group row" >
              ...
              <div class="col-sm-8">
                <b-field>
                  ...
                  :options="Object.entries(setting_modal).length > 0 ?  setting_modal.selected_loai_cv_setting : LIST_DUAN_KH" label="ten_du_an_kh" track-by="id_du_an_kh" :disabled="check_disabled"
