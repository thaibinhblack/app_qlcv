                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 col-md-9">
                        ...
                        <ul class="list-rule-duan">
                            <li><b-checkbox :value="selected_project+'.1'">Xem</b-checkbox></li>
                            <li><b-checkbox :value="selected_project+'.2'">Thêm</b-checkbox></li>
                            <li><b-checkbox :value="selected_project+'.3'">Sửa</b-checkbox></li>
                            <li><b-checkbox :value="selected_project+'.4'">Xóa</b-checkbox></li>
                            <li><b-checkbox :value="selected_project+'.5'">Xuất</b-checkbox></li>
                        </ul>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        api_update_du_an()
        {
            ...
            this.axios.post(this.$store.state.config.API_URL + 'nhanvien-da',form_nhanvien).then((response) => {
                console.log(response.data)
            })
