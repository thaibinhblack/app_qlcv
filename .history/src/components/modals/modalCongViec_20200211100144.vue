        ...
        <div class="col-sm-12 col-md-6">
            ...
            <div class="form-group row">        
              ...
              <div class="col-sm-4">
                  ...
                  <input type="number" v-model="cong_viec.time_nhan_viec.HH" min="7" max="24" class="tag-timetag-time">
                  <input type="number" v-model="cong_viec.time_nhan_viec.mm" min="0" max="59" class="tag-time">
                </div>
              <div class="col-sm-4">
                <b-field >
            ...
            <div class="form-group row">        
                ...
                <div class="col-sm-8">
                    <b-field>
                      <b-input type="text"   v-model="cong_viec.gio_thuc_hien" placeholder="Thời gian thực hiện (giờ)" ></b-input>
                    </b-field>
                </div>
            </div>
            <div class="form-group row">        
