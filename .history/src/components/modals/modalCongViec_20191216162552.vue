...
export default {
    ...
    created()
    {
        ...
        if(this.cong_viec_edit.id_cv_da)
        {
          ...
          this.cong_viec.ngay_tiep_nhan = this.cong_viec.ngay_tiep_nhan.length >=10 ? this.cong_viec.ngay_tiep_nhan.slice(0,10) : null
          this.cong_viec.ngay_giao_viec = this.cong_viec.ngay_giao_viec.length >=10 ? this.cong_viec.ngay_giao_viec.slice(0,10) : null
          this.cong_viec.ngay_hoan_thanh = this.cong_viec.ngay_hoan_thanh.length >=10 ? this.cong_viec.ngay_hoan_thanh.slice(0,10) : null
          this.cong_viec.ngay_cam_ket = this.cong_viec.ngay_cam_ket.length >= 10 ? this.cong_viec.ngay_cam_ket.slice(0,10) : null
