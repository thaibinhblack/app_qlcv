    ...
    <form @keydown.esc="close()" @submit.prevent="api_cong_viec()" style="width:100%;padding:15px;">
      <div class="row">
        <div class="col-sm-12 col-md-6">
          <div class="form-group row">
              ...
              <div class="col-sm-8">
                <b-field :disabled="cong_viec.trang_thai_td == 1 ?  true : false">
                  <!-- {{selected_du_an}} -->
        ...
        <div class="col-sm-12 col-md-6">
            ...
            <div class="form-group row">
              <label for="inputPassword3" class="col-sm-4 col-form-label" >Trạng thái <span class="color-warning">(*)</span> </label>
                <div class="col-sm-8">
                    <b-field>
                        <b-select v-model="cong_viec.trang_thai" required :disabled="cong_viec.trang_thai_td == 1 ?  true : false" >
      ...
      <div class="form-group row">
        <!-- {{Object.entries(this.getTaskEdit)}} -->
          <div class="col-sm-9" v-if="cong_viec.trang_thai_td == 0">
          ...
          <div class="col-sm-9" v-else>
              <button v-if="my_info.id_rule == 0" class="btn btn-form"> Chờ thẩm định</button>
              <button v-if="my_info.id_rule == 1"  class="btn btn-primary btn-form">Thẩm định </button>
              <button v-if="my_info.id_rule == 1" @click="$store.dispatch("sendThamDinh",{
          list_cv: [cong_viec.id_ccv_da],
          tham_dinh: 1})" class="btn btn-warning btn-form">Hủy thẩm định </button>
              <button type="button" class="btn btn-danger btn-form" @click="close()">Close</button>  
          </div>
      </div>
    </form>
