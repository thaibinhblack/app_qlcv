      ...
      <div class="row">
        <div class="col-sm-12 col-md-6">
          ...
          <div class="form-group row">        
            ...
            <!-- {{cong_viec.type_cv}} -->
            <div class="col-sm-8">
              <b-checkbox v-if="Object.entries(this.getTaskEdit).length <= 5" value="0" native-value="0"  v-model="cong_viec.type"  style="margin-top:10px;"></b-checkbox>
              <b-checkbox v-if="Object.entries(this.getTaskEdit).length <= 5" value="0" native-value="0"  v-model="KHYC"  style="margin-top:10px;"></b-checkbox>
            </div>
          </div>
          <div class="form-group row">        
...
export default {
    ...
    watch:
    {
      ...
      {
        console.log('loại công việc', val)
        this.cong_viec.id_loai_cv = val.id_loai_cv
        // this.$store.dispatch("fetchUserQLDA",val.id_du_an);
      },
      selected_du_an(val)
      {
