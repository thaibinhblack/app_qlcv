      ...
      <div class="row">
        <div class="col-sm-12 col-md-6">
          ...
          <div class="form-group row" >
              ...
              <div class="col-sm-8">
                <b-field>
                  <multiselect :disabled="update" v-model="selected_du_an_kh" :options="LIST_DUAN_KH" label="ten_du_an_kh" track-by="id_du_an_kh" 
      ...
      <div class="form-group row">
          <div class="col-sm-9">
            <!-- {{Object.entries(this.getTaskEdit).length === 0}} -->
              <button type="submit" :disabled="Object.entries(this.getTaskEdit).length > 0"  class="btn btn-primary btn-form">Thêm</button>
              <button type="button" :disabled="Object.entries(this.getTaskEdit).length == 0" class="btn btn-warning btn-form" @click="api_capnhat_congviec()">Cập nhật</button>
...
export default {
    ...
    methods:
    {
      ...
      api_cong_viec(P_ACTION)
      {
        ...
        // form_cong_viec.append("P_NGUOI_GIAO_VIEC",this.selected_user_giaoviec.id_nd)
        // form_cong_viec.append("P_NGUOI_NHAN_VIEC",this.selected_user_tiepnhan.id_nd)
        // form_cong_viec.append("P_ID_LOAI_CV",this.selected_loai_cv.id_loai_cv)
        ...
        else
        {
          ...
          // form_cong_viec.append("P_TYPE",cong_viec.type_cv == true ? 1 : 0)
        }
        const app = this;
