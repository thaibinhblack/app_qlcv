        ...
        <form @submit.prevent="api_bao_cao()" style="width:100%;padding:15px;">
            <div class="row">
                ...
                <div class="form-group row">
                    <div class="col-sm-5 col-md-5 col-form-label">Tên công việc</div>
                    <div class="col-sm-7">
            ...
            <div class="form-group row">        
                <label for="inputPassword3" class="col-sm-4 col-form-label" >Tiến độ ({{cong_viec_edit.tien_do}}%)</label>
                <div class="col-sm-8">
                    <b-field>
            ...
            <div class="form-group row">        
                <label for="inputPassword3" class="col-sm-4 col-form-label" >Nội dung báo cáo</label>
                <div class="col-sm-8">
                    <b-field>
                          <b-input maxlength="255" type="textarea"></b-input>
                    </b-field>
                </div>
            </div>
