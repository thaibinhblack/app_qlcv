      ...
      <div class="row">
        <div class="col-sm-12 col-md-6">
          <div class="form-group row">
              ...
              <div class="col-sm-8">
                <b-field :disabled="cong_viec.trang_thai == 5 ?  true : false">
                  <!-- {{selected_du_an}} -->
                  <!-- {{Object.entries(setting_modal.selected_du_an_setting).length}} -->
                  <multiselect v-model="selected_du_an" 
                  :disabled="cong_viec.trang_thai == 5 ?  true : false"
          ...
          <div class="form-group row">        
            ...
            <div class="col-sm-8">
              <b-field>
                <b-select v-model="cong_viec.type_cv" :disabled="cong_viec.trang_thai == 5 ?  true : false">
          ...
          <div class="form-group row">        
            ...
            <div class="col-sm-8">
              <b-input :disabled="cong_viec.trang_thai == 5 ?  true : false" type="text" placeholder="Người yêu cầu" v-model="cong_viec.nguoi_yeu_cau"></b-input>
            </div>
          </div>
          <div class="form-group row">        
            <label for="inputPassword3" class="col-sm-4 col-form-label" >Tên công việc <span class="color-warning">(*)</span></label>
            <div class="col-sm-8">
              <b-input :disabled="cong_viec.trang_thai == 5 ?  true : false" type="text" v-model="cong_viec.ten_cv" required placeholder="Tên công việc" ></b-input>
            </div>
          </div>
          <div class="form-group row">        
            <label for="inputPassword3"    class="col-sm-4 col-form-label" >Nội dung</label>
            <div class="col-sm-8">
              <b-input type="textarea"  minlength=""  :disabled="cong_viec.trang_thai == 5 ?  true : false"
           ...
           <div class="form-group row">        
            ...
            <div class="col-sm-8">
              ...
              maxlength="255" placeholder="Ghi chú" :disabled="cong_viec.trang_thai == 5 ?  true : false" v-model="cong_viec.ghi_chu"   ></b-input>
            </div>
          </div>
          <div class="form-group row">        
            <label for="inputPassword3" class="col-sm-4 col-form-label" >Người giao việc</label>
            <div class="col-sm-8">
                <multiselect  :show-labels="false" :disabled="cong_viec.trang_thai == 5 ?  true : false" v-model="selected_user_giaoviec" :options="LIST_USER" label="display_name" track-by="id_nd" ></multiselect>
            </div>
          </div>
          <div class="form-group row">        
            ...
            <!-- {{selected_user_tiepnhan}} -->
             <!-- :disabled="selected_user_tiepnhan && update || my_info.id_rule == 1"  -->
              <multiselect  :disabled="cong_viec.trang_thai == 5 ?  true : false" :show-labels="false" v-model="selected_user_tiepnhan" :options="LIST_USER" label="display_name" track-by="id_nd"></multiselect>
            </div>
          </div>
        ...
        <div class="col-sm-12 col-md-6">
            <div class="form-group row">        
              ...
              <div class="col-sm-8">
                <b-field >
                  <b-input type="date" :disabled="cong_viec.trang_thai == 5 ?  true : false" style="width: 100%;"  v-model="cong_viec.ngay_tiep_nhan"></b-input>
            ...
            <div class="form-group row">        
              ...
              <div class="col-sm-4">
                  <input type="number" :disabled="cong_viec.trang_thai == 5 ?  true : false" v-model="cong_viec.time_nhan_viec.HH" min="1" max="24" class="tag-time" style="margin-right:5px;"> giờ :
                  <input type="number" :disabled="cong_viec.trang_thai == 5 ?  true : false" v-model="cong_viec.time_nhan_viec.mm" min="0" max="59" class="tag-time" style="margin-left: 5px;"> phút
              </div>
              <div class="col-sm-4">
                <b-field >
                  
                   <b-input type="date"  :disabled="cong_viec.trang_thai == 5 ?  true : false"  style="width: 100%;"  v-model="cong_viec.ngay_giao_viec"></b-input>
            ...
            <div class="form-group row">        
                <label for="inputPassword3" class="col-sm-4 col-form-label" >Ngày hoàn thành</label>
                 <div class="col-sm-4">
                  <input type="number" :disabled="cong_viec.trang_thai == 5 ?  true : false"  v-model="cong_viec.time_hoan_thanh.HH" :min="1" :max="24" class="tag-time" style="margin-right:5px;"> giờ :
                  <input type="number" :disabled="cong_viec.trang_thai == 5 ?  true : false" v-model="cong_viec.time_hoan_thanh.mm" :min="0" :max="59" class="tag-time" style="margin-left: 5px;"> phút
                </div>
                <div class="col-sm-4">
                  <b-field >
                     <b-input type="date" :disabled="cong_viec.trang_thai == 5 ?  true : false"  style="width: 100%;"  v-model="cong_viec.ngay_hoan_thanh"></b-input>
            ...
            <div class="form-group row">        
                ...
                <div class="col-sm-8">
                  <b-field >
                     <b-input type="date" :disabled="cong_viec.trang_thai == 5 ?  true : false"  style="width: 100%;"  v-model="cong_viec.ngay_cam_ket"></b-input>
            ...
            <div class="form-group row">        
                ...
                <div class="col-sm-3">
                  <b-field>
                    <b-input  type="number" :disabled="cong_viec.trang_thai == 5 ?  true : false" min="0" max="100"  v-model="cong_viec.tien_do" required placeholder="Tiến độ" ></b-input>
                  </b-field>
                </div>
                <div class="col-sm-5">
                    <b-field>
            ...
            <div class="form-group row">        
                ...
                <div class="col-sm-8">
                    <b-field>
                      <b-input type="text" :disabled="cong_viec.trang_thai == 5 ?  true : false" v-model="cong_viec.gio_thuc_hien" placeholder="Thời gian thực hiện (giờ)" ></b-input>
                    </b-field>
                </div>
            </div>
            <div class="form-group row">        
                ...
                <div class="col-sm-8">
                  <b-input   type="number" :disabled="cong_viec.trang_thai == 5 ?  true : false" v-model="cong_viec.do_uu_tien" maxlength="1" max="9" min="1" required placeholder="Độ ưu tiên" ></b-input>
                </div>
            </div>
            <div class="form-group row">        
                <label for="inputPassword3" class="col-sm-4 col-form-label" >Mã JIRA</label>
                <div class="col-sm-8">
                  <b-input type="text" :disabled="cong_viec.trang_thai == 5 ?  true : false"  v-model="cong_viec.ma_jra" placeholder="Mã JIIRA" ></b-input>
                </div>
            </div>
             <div class="form-group row">        
            ...
            <div class="form-group row">
              <label for="inputPassword3" class="col-sm-4 col-form-label" >Trạng thái <span class="color-warning">(*)</span> </label>
                <div class="col-sm-8">
                    <b-field>
                        <b-select v-model="cong_viec.trang_thai" required :disabled="cong_viec.trang_thai == 5 ?  true : false" >
