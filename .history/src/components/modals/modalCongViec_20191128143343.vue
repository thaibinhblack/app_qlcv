    ...
    <div class="row">
      <div class="col-sm-12 col-md-6">
        ...
        <div class="form-group row">        
          ...
          <div class="col-sm-8">
              <multiselect :disabled="update" v-model="selected_user_giaoviec" :options="users" label="username_nd" track-by="id_nd" ></multiselect>
          </div>
        </div>
        <div class="form-group row">        
          ...
          <div class="col-sm-8">
             ...
             <multiselect :disabled="update" v-model="selected_user_tiepnhan" :options="users" label="username_nd" track-by="id_nd"></multiselect>
          </div>
        </div>
      </div>
      <div class="col-sm-12 col-md-6">
            ...
            <div class="col-sm-8">
              <b-field >
                  <b-datepicker
                      ...
                      :disabled="cong_viec.ngay_cam_ket != null"
                      required
                      @date-formatter="formatter(date)"
                      style="z-index:9999"
                      icon="calendar-today">
      ...
      api_cong_viec()
        {
          ...
          {
              cong_viec.append("P_TYPE",1)
          }
          else
          {
            cong_viec.append("P_TYPE",this.cong_viec.type == true ? 0 : 1)
          }
          const app = this;
    ...
    created()
    {
      this.api_loai_cv()
        ...
        if(this.cong_viec_edit.id_cv_da)
        {
          ...
          this.cong_viec.type = this.cong_viec_edit.type_cv == 0 ? true : false
          // this.selected_user_tiepnhan = this.users.filter((value,index,array) => {
          //   return array[index].id_nd == this.cong_viec_edit.nguoi_nhan_viec
          // })[0]
