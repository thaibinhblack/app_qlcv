      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-md-6">
            ...
            <div class="form-group row">        
                ...
                <div class="col-sm-3">
                  <b-field>
                    <b-input  type="number" :disabled="check_disabled"  v-model="parseIntcong_viec.tien_do" required placeholder="Tiến độ" ></b-input>
                  </b-field>
                </div>
                <div class="col-sm-5">
                    <b-field>
                      <b-slider type="is-success"   v-model="cong_viec.tien_do" :custom-formatter="val => parseInt(val) + '%'"></b-slider>
                    </b-field>
                </div>
            </div>
            <div class="form-group row">        
