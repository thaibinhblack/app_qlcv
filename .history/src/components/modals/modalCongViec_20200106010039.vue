      ...
      <div class="row">
        <div class="col-sm-12 col-md-6">
          ...
          <div class="form-group row">        
            ...
            <div class="col-sm-8">
              {{cong_viec.type}}
              <b-checkbox v-if="Object.entries(this.getTaskEdit).length <= 5" value="1" native-value="1"  v-model="cong_viec.type"  style="margin-top:10px;"></b-checkbox>
              <b-checkbox v-model="KHYC" value="1" native-value="1"  style="margin-top:10px;"></b-checkbox>
            </div>
          </div>
          <div class="form-group row">        
