...
<b-tabs>
      ...
      <div class="row">
        <div class="col-sm-12 col-md-6">
          ...
          <div class="form-group row">        
            ...
            <div class="col-sm-8">
              <b-checkbox  v-model="getTaskEdit.type_cv"  style="margin-top:10px;"></b-checkbox>
            </div>
          </div>
          <div class="form-group row">        
            <label for="inputPassword3" class="col-sm-4 col-form-label" >Tên người yêu cầu</label>
            <div class="col-sm-8">
              <b-input type="text" placeholder="Người yêu cầu" v-model="getTaskEdit.nguoi_yeu_cau"></b-input>
            </div>
          </div>
          <div class="form-group row">        
            <label for="inputPassword3" class="col-sm-4 col-form-label" >Tên công việc</label>
            <div class="col-sm-8">
              <b-input :disabled="update" type="text" v-model="getTaskEdit.ten_cv" required placeholder="Tên công việc" ></b-input>
            </div>
          </div>
          <div class="form-group row">        
            ...
            <div class="col-sm-8">
              ...
              maxlength="255" placeholder="Nội dung"  v-model="getTaskEdit.noi_dung_cv" required  ></b-input>
            </div>
          </div>
           <div class="form-group row">        
  ...
  <b-tab-item label="Công việc gốc">
    <cong-viec-goc :id_cv_da="cong_viec.id_cv_da" :loai_cv="loai_cv" />
  </b-tab-item>
</b-tabs>
</template>
...
export default {
    ...
    computed:{
      ...mapGetters(["getUser", "getTaskEdit"]),
      nguoi_tham_dinh()
      {
