  ...
  <form @submit.prevent="api_cong_viec()" style="width:100%;padding:15px;">
    <div class="row">
      <div class="col-sm-12 col-md-6">
        ...
        <div class="form-group row">        
          <label for="inputPassword3" class="col-sm-4 col-form-label" >Loại công việc {{cong_viec.id_loai_cv}}</label>
          <div class="col-sm-8">
            <b-field>
        ...
        <div class="form-group row">        
          <label for="inputPassword3" class="col-sm-4 col-form-label" >KH yêu cầu {{cong_viec.type}}</label>
          <div class="col-sm-8">
            <b-checkbox v-model="cong_viec.type" native-value="0" value="0"></b-checkbox>
          </div>
        </div>
        <div class="form-group row">        
