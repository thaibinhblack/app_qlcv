  ...
  <form @submit.prevent="api_cong_viec()" style="width:100%;padding:15px;">
    <div class="row">
      ...
      <div class="col-sm-12 col-md-6">
        ...
        <div class="form-group row">        
            <label for="inputPassword3" class="col-sm-4 col-form-label" >Giờ làm việc</label>
            <div class="col-sm-8">
                <b-field>
        ...
        <div class="form-group row">        
            ...
            <div class="col-sm-8">
                <b-field>
                  <b-input type="text" v-model="cong_viec.gio_thuc_hien" placeholder="Mã JIIRA" ></b-input>
                </b-field>
            </div>
        </div>
        <div class="form-group row">        
