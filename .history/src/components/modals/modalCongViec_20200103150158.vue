      ...
      <div class="row">
        <div class="col-sm-12 col-md-6">
          ...
          <div class="form-group row">        
            ...
            <div class="col-sm-8">
                <multiselect    :show-labels="false"  v-model="selected_user_giaoviec" :options="users_giaoviec" label="display_name" track-by="id_nd" ></multiselect>
            </div>
          </div>
          <div class="form-group row">        
...
export default {
    ...
    watch:
    {
      ...
      {
        console.log('CÔNG VIỆC EDIT',newVal)
    ...
    created()
    {
        ...
        console.log('cong việc',this.cong_viec)
      // this.api_du_an()
      // this.api_users()
