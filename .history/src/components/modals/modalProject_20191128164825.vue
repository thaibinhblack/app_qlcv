                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 col-md-9">
                        ...
                        <ul class="list-rule-duan">
                            <li><b-checkbox v-model="quyen_duan.q_xem" :native-value="selected_project+'.1'" :value="selected_project+'.1'">Xem</b-checkbox></li>
                            <li><b-checkbox v-model="quyen_duan.q_them" :native-value="selected_project+'.2'" :value="selected_project+'.2'">Thêm</b-checkbox></li>
                            <li><b-checkbox v-model="quyen_duan.q_sua" :native-value="selected_project+'.3'" :value="selected_project+'.3'">Sửa</b-checkbox></li>
                            <li><b-checkbox v-model="quyen_duan.q_xoa" :native-value="selected_project+'.4'" :value="selected_project+'.4'">Xóa</b-checkbox></li>
                            <li><b-checkbox v-model="quyen_duan.q_xuat" :native-value="selected_project+'.5'" :value="selected_project+'.5'">Xuất</b-checkbox></li>
                        </ul>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        {
            this.axios.get(this.$store.state.config.API_URL + 'quyen-nhanvien-da?api_token='+this.$session.get('token')+'&id_nd='+id+'&id_du_an_kh='+this.selected_project)
            .then((response) =>{
                this.quyen_duan = response.data[0]
            })
        }
