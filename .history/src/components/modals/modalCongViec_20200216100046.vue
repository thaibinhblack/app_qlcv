            ...
            <div class="col-sm-8">
              <!-- {{GROUP_LCV}} -->
                <b-field>
                    ...
                    :multiple="false"
                    :disabled="cong_viec.trang_thai_td == 1 ?  true : false"
                    :group-values=" Object.entries(setting_modal.selected_loai_cv_setting).length == 0 ? '' : 'children'"
                    :group-label=" Object.entries(setting_modal.selected_loai_cv_setting).length == 0 ? '' : 'parent' "
                    :group-select="false"
                    :show-labels="false"
