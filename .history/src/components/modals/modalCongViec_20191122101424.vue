...
export default {
    ...
    methods:
    {
        api_cong_viec()
        {
          ...
          cong_viec.append("P_NGAY_TIEP_NHAN",this.cong_viec.ngay_tiep_nhan.getDate() + '-' + this.cong_viec.ngay_tiep_nhan.getMonth() + ''+ this.cong_viec.ngay_tiep_nhan.getFullYear() )
          cong_viec.append("P_NGAY_HOAN_THANH",this.cong_viec.ngay_hoan_thanh.getDate() + '-' + this.cong_viec.ngay_hoan_thanh.getMonth() + ''+ this.cong_viec.ngay_hoan_thanh.getFullYear())
