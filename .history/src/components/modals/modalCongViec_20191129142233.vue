              ...
              <div class="col-sm-8">
                  <b-field>
                      <b-select v-model="cong_viec.trang_thai" required>
                          <option :disabled="cong_viec.trang_thai > 1" value="1" selected>Chưa thực hiện</option>
                          <option :disabled="cong_viec.trang_thai > 2" value="2">Đang thực hiện</option>
                          <option :disabled="cong_viec.trang_thai > 3" value="3">Đã hoàn thành</option>
