    ...
    created()
    {
        ...
        if(this.cong_viec_edit.id_cv_da)
        {
          this.selected_loai_cv = this.loai_cv.filter((value,index,array) => {
            return array[index].children.id_loai_cv == this.cong_viec_edit.id_loai_cv
          })[0]
          console.log('lcv',this.selected_loai_cv, this.loai_cv, this.cong_viec_edit.id_loai_cv)
