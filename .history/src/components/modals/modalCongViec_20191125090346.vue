    ...
    <div class="row">
      <div class="col-sm-12 col-md-6">
        <div class="form-group row">
            <div class="col-sm-4 col-form-label">Dự án {{update}}</div>
            <div class="col-sm-8">
              <b-field>
...
export default {
    ...
    methods:
    {
        api_cong_viec()
        {
          ...
          cong_viec.append("P_NGAY_HOAN_THANH",this.cong_viec.ngay_tiep_nhan.getFullYear() + '-' + ( this.cong_viec.ngay_tiep_nhan.getMonth() + 1) + '-' + this.cong_viec.ngay_tiep_nhan.getDate() )
