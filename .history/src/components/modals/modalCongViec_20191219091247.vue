    ...
    <form @submit.prevent="api_tham_dinh()">
      <div class="row">
          <div class="form-group col-sm-12 col-md-6 row">
            ...
            <div class="col-sm-8">
              <b-field>
                <b-input type="date" placeholder="Thẩm định thời gian"></b-input>
              </b-field>
            </div> 
          </div>
          ...
          <div class="form-group col-sm-12 col-md-6 row">
            ...
            <div class="col-sm-8">
              <b-field>
                <b-input type="text" placeholder="Thẩm định chất lượng"></b-input>
              </b-field>
            </div> 
          </div>
          ...
          <div class="form-group col-sm-12 col-md-6 row">
            ...
            <div class="col-sm-8">
              <b-field>
                <b-input disabled type="text" v-model="my_info.display_name" placeholder="Người thẩm định"></b-input>
              </b-field>
            </div> 
          </div>
