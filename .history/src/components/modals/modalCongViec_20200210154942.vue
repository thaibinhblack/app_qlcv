      ...
      <div class="row">
        <div class="col-sm-12 col-md-6">
          <div class="form-group row">
              ...
              <div class="col-sm-8">
                <b-field>
                  <multiselect v-model="selected_du_an" :options="Object.entries(setting_modal).length > 0 ?  setting_modal.selected_du_an_setting : LIST_DUAN" label="ten_du_an" :disabled="check_disabled" 
