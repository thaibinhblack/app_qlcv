      ...
      <div class="form-group row">
        <!-- {{Object.entries(this.getTaskEdit)}} -->
          <div class="col-sm-9" v-if="cong_viec.trang_thai_td == 1 && cong_viec.trang_thai == 3">
              ...
              <button v-if="my_info.id_rule == 1" :disabled="my_info.id_rule == 0 ? true: false"  @click="tham_dinh()" class="btn btn-primary btn-form">Thẩm định </button>
              <button v-if="my_info.id_rule == 1" @click="huy_tham_dinh()"  class="btn btn-warning btn-form">Hủy thẩm định </button>
              <button type="button" class="btn btn-danger btn-form" @click="close()">Nhập lại</button>  
          </div>
          <div class="col-sm-9" v-else>
            <!-- {{Object.entries(this.getTaskEdit).length === 0}} -->
              ...
              <button type="button" @click="clear()" class="btn btn-success btn-form">Nhập lại</button>
