...
<div class="card" style="padding:15px;">
    <div class="row">
        ...
        <div class="col-sm-12 item-filter">
                <b-field>
                <b-select v-model="selected_project" expanded :disabled="LIST_DUAN_KH.length == 0">
...
export default {
    props: ["hinhthuc_loc", "my_info", "LIST_USER"],
    components:
    {
        Multiselect
    },
    ...
    computed: {
        ...mapGetters(["LIST_DUAN", "LIST_DUAN_KH", "GROUP_LCV"])
    },
    watch:
    {
    ...
    created()
    {
        console.log('LIST_USER',this.LIST_USER)
    }
}
</script>