        ...
        <div class="col-sm-12 col-md-6">
          ...
          <div class="form-group row">        
            ...
            <!-- {{selected_user_tiepnhan}} -->
              <multiselect :disabled="update" v-model="selected_user_tiepnhan" :options="users" label="display_name" track-by="id_nd"></multiselect>
            </div>
          </div>
          <div class="form-group row">        
            ...
            <div class="col-sm-8">
                ...
                <b-input disabled type="text" v-model="cong_viec.nguoi_nhap_viec"></b-input>
            </div>
          </div>
        </div>
        <div class="col-sm-12 col-md-6">
