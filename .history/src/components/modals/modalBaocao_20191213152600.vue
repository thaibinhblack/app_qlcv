...
export default {
    ...
    methods: {
        api_bao_cao()
        {
            ...
            baocao.append("P_ID_ND",this.cong_viec_edit.trang_thai)
            baocao.append("P_NOI_DUNG_BAOCAO", this.noidung)
            this.axios.post(this.$store.state.config.API_URL + 'cong-viec/'+ this.cong_viec_edit.id_cv_da +'/baocao?api_token='+this.$cookies.get('token'))
            .then((respose) => {
