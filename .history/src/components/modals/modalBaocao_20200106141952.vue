...
export default {
    ...
    methods: {
        api_bao_cao()
        {
            ...
            baocao.append("P_ID_CV", this.getTaskEdit.tien_do)
            baocao.append("P_TIEN_DO",this.getTaskEdit.tien_do)
            ...
            .then((respose) => {
                ...
                const content = this.my_info.display_name + ' vừa báo cáo tiến độ công việc ' + this.getTaskEdit.ten_cv + ' Tiến độ công việc: ' + this.cong_viec_edit.tien_do +'% Nội dung là: '+ this.noidung
    ...
    {
        // this.api_get_baocao()
        console.log('cv edit',this.getTaskEdit)
    }
}
</script>
