      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-md-6">
            ...
            <div class="form-group row">        
                ...
                <div class="col-sm-8">
                    <b-field>
                      <b-input type="text" :disabled="cong_viec.trang_thai_td == 1 || cong_viec.trang_thai_td == 2 ?  true : false" v-model="gio_thuc_hien" placeholder="Thời gian thực hiện (giờ)" ></b-input>
                    </b-field>
                </div>
            </div>
            <div class="form-group row">        
...
export default {
    ...
    computed:{
      ...
      gio_thuc_hien()
      {
        return (this.cong_viec.time_hoan_thanh.HH + (this.cong_viec.time_hoan_thanh.mm / 60) ) - (this.cong_viec.time_nhan_viec.HH + (this.cong_viec.time_nhan_viec.mm / 60) ) 
