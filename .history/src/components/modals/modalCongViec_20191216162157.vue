...
export default {
    ...
    created()
    {
        ...
        if(this.cong_viec_edit.id_cv_da)
        {
          ...
          this.cong_viec.ngay_giao_viec = this.cong_viec.ngay_giao_viec.slice(0,10)
          this.cong_viec.ngay_hoan_thanh = this.cong_viec.ngay_hoan_thanh.slice(0,10)
          this.cong_viec.ngay_cam_ket = this.cong_viec.ngay_cam_ket.slice(0,10)
