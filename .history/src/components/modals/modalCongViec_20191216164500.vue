      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-md-6">
          <div class="form-group row">        
              ...
              <div class="col-sm-8">
                <!-- {{cong_viec.ngay_tiep_nhan}} -->
                <!-- {{ngay_tiep_nhan}} -->
                {{ngay_tiep_nhan}}
                <b-field >
                  
                  <input type="date" style="width: 100%;"  v-model="cong_viec.ngay_tiep_nhan">
                    <!-- <b-datepicker
                        :disabled="update"
...
export default {
    ...
    computed:{
      ...
      ngay_tiep_nhan()
      {
        return this.formatDate(new Date(this.cong_viec.ngay_tiep_nhan).toISOString().substr(0,10))
      },
      ngay_giao_viec()
      {
        return this.formatDate(new Date(this.cong_viec.ngay_giao_viec).toISOString().substr(0,10))
      },
      ngay_hoan_thanh()
      {
        return this.formatDate(new Date(this.cong_viec.ngay_hoan_thanh).toISOString().substr(0,10))
      },
      ngay_cam_ket()
      {
        return this.formatDate(new Date(this.cong_viec.ngay_cam_ket).toISOString().substr(0,10))
      }
    },
    watch:
    {
    ...
    created()
    {
        ...
        {
          //  this.cong_viec_edit.ngay_tiep_nhan =  this.formatDate(new Date(this.cong_viec_edit.ngay_tiep_nhan).toISOString().substr(0,10))
          // console.log('Ngày tiếp nhận', this.formatDate(new Date(this.cong_viec_edit.ngay_tiep_nhan).toISOString().substr(0,10)))
          // console.log('DATE',this.cong_viec_edit.ngay_tiep_nhan.toString().substr(0,10))
          // this.cong_viec_edit.ngay_tiep_nhan = this.cong_viec_edit.ngay_tiep_nhan.toString().substr(0,10)
          // this.cong_viec_edit.ngay_hoan_thanh = this.cong_viec_edit.ngay_hoan_thanh.toString().substr(0,10)
          // this.cong_viec_edit.ngay_cam_ket = this.cong_viec_edit.ngay_cam_ket.toString().substr(0,10)
          // this.cong_viec_edit.ngay_giao_viec = this.cong_viec_edit.ngay_giao_viec.toString().substr(0,10)
          // this.cong_viec_edit.ngay_tiep_nhan = this.cong_viec_edit.ngay_tiep_nhan.length >=10 ? this.cong_viec_edit.ngay_tiep_nhan.slice(0,10) : null
          // this.cong_viec_edit.ngay_giao_viec = this.cong_viec_edit.ngay_giao_viec.length >=10 ? this.cong_viec_edit.ngay_giao_viec.slice(0,10) : null
          // this.cong_viec_edit.ngay_hoan_thanh = this.cong_viec_edit.ngay_hoan_thanh.length >=10 ? this.cong_viec_edit.ngay_hoan_thanh.slice(0,10) : null
          // this.cong_viec_edit.ngay_cam_ket = this.cong_viec_edit.ngay_cam_ket.length >= 10 ? this.cong_viec_edit.ngay_cam_ket.slice(0,10) : null
          this.cong_viec_edit = this.cong_viec_edit
          this.cong_viec_edit.ngay_tiep_nhan = this.formatDate(new Date(this.cong_viec.ngay_tiep_nhan).toISOString().substr(0,10))
          this.cong_viec_edit.ngay_giao_viec = this.formatDate(new Date(this.cong_viec.ngay_giao_viec).toISOString().substr(0,10))
          this.cong_viec_edit.ngay_hoan_thanh = this.formatDate(new Date(this.cong_viec.ngay_hoan_thanh).toISOString().substr(0,10))
          this.cong_viec_edit.ngay_cam_ket = this.formatDate(new Date(this.cong_viec.ngay_cam_ket).toISOString().substr(0,10))
          // this.cong_viec_edit.ngay_tiep_nhan = this.formatDate(new Date(this.cong_viec.ngay_tiep_nhan).toISOString().substr(0,10))
          console.log('ngày',this.cong_viec)
          // this.cong_viec.type = this.cong_viec_edit.type_cv == 1 ? true : false
          // console.log('cong-viec',this.cong_viec)      
        }
