        ...
        <div class="col-sm-12 col-md-6">
            ...
            <div class="form-group row">        
                <label for="inputPassword3" class="col-sm-4 col-form-label" >Ngày hoàn thành</label>
                 <div class="col-sm-4">
                  <input type="number" :disabled="cong_viec.trang_thai_td == 1 || cong_viec.trang_thai_td == 2 ?  true : false"  v-model="cong_viec.time_hoan_thanh.HH" :min="1" :max="24" class="tag-time" style="margin-right:5px;"> giờ :
                  <input type="number" :disabled="cong_viec.trang_thai_td == 1 || cong_viec.trang_thai_td == 2 ?  true : false" v-model="cong_viec.time_hoan_thanh.mm" :min="0" :max="59" class="tag-time" style="margin-left: 5px;"> phút
                </div>
                <div class="col-sm-4">
                  <b-field >
            ...
            <div class="form-group row">        
                ...
                <div class="col-sm-5">
                    <b-field>
                      <b-slider type="is-success"   v-model="parseInt(this.cong_viec.tien_do)" :custom-formatter="val => val + '%'"></b-slider>
                    </b-field>
                </div>
            </div>
            <div class="form-group row">        
                ...
                <div class="col-sm-4">
                    <b-field>
                      <b-input type="text" @input="cong_viec.tien_do == 100 ? cong_viec.trang_thai = 3 : cong_viec.trang_thai = 2" :disabled="cong_viec.trang_thai_td == 1 || cong_viec.trang_thai_td == 2 ?  true : false" v-model="cong_viec.gio_thuc_hien" placeholder="Thời gian thực hiện (giờ)" ></b-input>
                    </b-field>
                </div>
            </div>
            <div class="form-group row">        
            ...
            <div class="form-group row">        
                ...
                <div class="col-sm-8">
                  <b-input type="text" :disabled="cong_viec.trang_thai_td == 1 || cong_viec.trang_thai_td == 2 ?  true : false"  v-model="cong_viec.ma_jra" placeholder="Mã JIIRA" ></b-input>
                </div>
            </div>
              <div class="form-group row">
              <label for="inputPassword3" class="col-sm-4 col-form-label" >Trạng thái <span class="color-warning">(*)</span> </label>
                <div class="col-sm-8">
                    <b-field>
                        <b-select v-model="cong_viec.trang_thai" required :disabled="cong_viec.trang_thai_td == 1 || cong_viec.trang_thai_td == 2 ?  true : false" @input="selected_trang_thai()" >
