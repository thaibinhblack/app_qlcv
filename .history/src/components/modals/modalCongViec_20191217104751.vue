      ...
      <div class="row">
        <div class="col-sm-12 col-md-6">
          ...
          <div class="form-group row">        
            ...
            <div class="col-sm-8">
                <b-field>
                  <multiselect :disabled="update" v-model="selected_du_an_kh" :options="loai_cv"  group-values="children" group-label="ten_Loai_cv"  
                  track-by="id_loai_cv" label="ten_Loai_cv"
