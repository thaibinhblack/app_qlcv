...
export default {
    ...
    created()
    {
        ...
        {
          console.log('DATE',this.cong_viec_edit.ngay_tiep_nhan.toString())
          this.cong_viec_edit.ngay_tiep_nhan = this.cong_viec_edit.ngay_tiep_nhan.toString().substr(0, 10)
          this.cong_viec_edit.ngay_hoan_thanh = this.cong_viec_edit.ngay_hoan_thanh.toISOString().substr(0, 10)
          this.cong_viec_edit.ngay_cam_ket = this.cong_viec_edit.ngay_cam_ket.toISOString().substr(0, 10)
          this.cong_viec_edit.ngay_giao_viec = this.cong_viec_edit.ngay_giao_viec.toISOString().substr(0, 10)
