      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-md-6">
            ...
            <div class="form-group row">        
                ...
                <div class="col-sm-8">
                    <b-field>
                      <b-input type="text" :disabled="(cong_viec.trang_thai == 3 && cong_viec.gio_thuc_hien > 0) ?  true : false" v-model="cong_viec.gio_thuc_hien" placeholder="Thời gian thực hiện (giờ)" ></b-input>
                    </b-field>
                </div>
            </div>
            <div class="form-group row">        
