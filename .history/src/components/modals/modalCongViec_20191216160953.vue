...
export default {
    ...
    watch:
    {
      cong_viec_edit(newVal)
      {
        ...
        this.cong_viec.ngay_tiep_nhan =  this.formatDate(new Date(this.cong_viec.ngay_tiep_nhan).toISOString().substr(0,10))
        console.log('Ngày tiếp nhận', this.formatDate(new Date(this.cong_viec.ngay_tiep_nhan).toISOString().substr(0,10)))
      },
      update(newVal)
      {
        console.log(newVal)
