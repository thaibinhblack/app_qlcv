    ...
    <div class="row">
      <div class="col-sm-12 col-md-6">
        <div class="form-group row">
            <div class="col-sm-4 col-form-label">Dự án {{selected_project}}</div>
            <div class="col-sm-8">
              <b-field>
                <b-select v-model="cong_viec.id_du_an">
        ...
        <div class="form-group row">        
          ...
          <div class="col-sm-8">
            <b-input type="text"  placeholder="Tên công việc" ></b-input>
          </div>
        </div>
        <div class="form-group row">        
          ...
          <div class="col-sm-8">
            ...
            maxlength="255" placeholder="Nội dung"  ></b-input>
          </div>
        </div>
        <div class="form-group row">        
      ...
      <div class="col-sm-12 col-md-6">
        <div class="form-group row">        
          ...
          <div class="col-sm-8">
            <b-input type="text"  placeholder="Người giao việc" ></b-input>
          </div>
        </div>
        <div class="form-group row">        
          <label for="inputPassword3" class="col-sm-4 col-form-label" >Người tiếp nhận</label>
          <div class="col-sm-8">
            <b-input type="text"  placeholder="Người tiếp nhận" ></b-input>
          </div>
        </div>
          <div class="form-group row">        
...
export default {
    ...
    watch:
    {
      ...
      {
        console.log(newVal)
        this.cong_viec.id_du_an = newVal
