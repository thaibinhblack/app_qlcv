...
export default {
    ...
    created()
    {
        ...
        if(this.cong_viec_edit.id_cv_da)
        {
          ...
          this.cong_viec_edit.ngay_hoan_thanh = this.cong_viec_edit.ngay_hoan_thanh.toISOString()
          this.cong_viec_edit.ngay_cam_ket = this.cong_viec_edit.ngay_cam_ket.toISOString()
          this.cong_viec_edit.ngay_giao_viec = this.cong_viec_edit.ngay_giao_viec.toISOString()
