 ...
 <div class="col-4 col-md-4 col-sm-6 col-lg-3 col-xl-3 item-group-task">
    <div class="card card-task">
        <div class="card-title">
            <h3 style="line-height:36px">Công việc được giao ({{getCongViecByStatus(1).length}})</h3>
        </div>
        ...
        <draggable class="list-group" :list="list1" group="people"  >
            ...
            <div
                ...
                v-for="(element, index) in getCongViecByStatus(1)"
                :key="index"
...
export default {
    computed: {
        ...mapGetters(["getCongViecByStatus"])
    }
}
</script>