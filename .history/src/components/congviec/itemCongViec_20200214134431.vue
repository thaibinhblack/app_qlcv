        ...
        <draggable class="list-group" :list="list_congviec" group="people"  >
            ...
            <div
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <small>{{element.ten_nnv != null ? element.ten_nnv : 'Chưa có người nhận việc'}}</small>
                    </div>
                 ...
                 <p><small style="font-size: 11px;">{{element.ngay_giao_viec}} - {{element.ngay_cam_ket.slice(0,10)}}</small></p>
