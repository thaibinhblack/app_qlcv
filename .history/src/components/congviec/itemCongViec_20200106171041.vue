            ...
            <div
                ...
                <div class="row">
                    <div class="status col-md-12">
                        <div class="color" style="width:40px;height:10px;float:left; background:#e2e2e2e2;border-radius: 5px;margin-top:7px;margin-right:5px;"></div> <span>{{element.ten_loai_cv}}</span>
                    </div>
                    <div class="col-md-12">
