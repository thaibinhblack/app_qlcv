...
<form @submit.prevent="api_du_an()" class="form-rule row" style="padding: 15px;">
    ...
    <div class="col-sm-12 col-md-6">
        ...
        <div class="form-group row">
            <label for="inputPassword3" class="col-sm-3 col-form-label" >Trạng thái 1</label>
            <div class="col-sm-9">
                <b-field>
                    <b-select v-model="du_an_kh.trang_thai_du_an" required>
                        <option v-for="(trang_thai,index) in getListTrangThai" :key="index" :value="getListTrangThai.id_trang_thai">
