<template>
    <form>
         <div class="form-group row">
            <label for="inputPassword3" class="col-sm-4 col-form-label" >Danh sách phòng ban</label>
            <div class="col-sm-8">
                <b-field>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
            <b-input type="text" placeholder="SDT" icon="phone" v-model="user.ngay_sinh_nd"></b-input>
            </div>
        </div>
        <div class="form-group row">
