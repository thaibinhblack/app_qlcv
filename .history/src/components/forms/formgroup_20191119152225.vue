<template>
    <form class="form-rule" >
        ...
        <div class="form-group row">
            ...
            <button type="submit" :disabled="!updatePhongBan" class="btn btn-warning btn-form">Sửa</button>
            <button type="submit" :disabled="!updatePhongBan" class="btn btn-danger btn-form">Xóa</button>
            <button type="button" v-if="updatePhongBan == true" class="btn btn-warning btn-form" @click="$emit('roolback',false)">Clear</button>
            </div>
