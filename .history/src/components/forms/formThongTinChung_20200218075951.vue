 ...
 <form class="form-rule" style="padding: 15px;">
    ...
    <div class="row" v-for="(setting,index) in settings" :key="index" style="margin: 10px 0;">
        ...
        <div class="col-sm-12 col-md-8">
            <b-field>
                <b-input v-model="setting.VALUE_ATTRIBUTE" :placeholder="setting.NOT_ATTRIBUTE" :type="setting.TYPE_ATTRIBUTE" ></b-input>
            </b-field>
        </div>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12" style="margin-top: 15px;">
            <button v-if="getAction_danhmuc.them == '5.2'" type="button"    class="btn btn-primary btn-form">Thêm</button>
