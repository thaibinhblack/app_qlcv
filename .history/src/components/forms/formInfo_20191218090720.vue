...
export default {
    ...
    methods:
    {
        api_update_info_user()
        {
            ...
            this.axios.post(this.$store.state.config.API_URL + 'info',user).then((response) => {
...
<style scoped>
.avatar, .avatar img {width: 120px;height: 120px; border-radius: 50%;background: #e2e2e2;margin: auto}
</style>