...
<form @submit.prevent="api_du_an()" class="form-rule row" style="padding: 15px;">
    ...
    <div class="col-sm-12 col-md-9">
        <button v-if="getAction_projects.them == '3.2'" type="submit"  class="btn btn-primary btn-form">Thêm</button>
        <button v-if="getAction_projects.sua == '3.3'" type="button"  class="btn btn-warning btn-form" @click="updateDuAn()">Cập nhật</button>
