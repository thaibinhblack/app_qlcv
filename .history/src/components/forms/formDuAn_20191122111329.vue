...
<form @submit.prevent="api_du_an()" class="form-rule" style="padding: 15px;">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <b-input type="text" placeholder="Nhập khách hàng"></b-input>
            <div class="list-kh card">
                <ul>
...
export default {
    ...
    methods: {
        api_kh()
        {
            this.axios.get(this.$store.state.config.API_URL + 'customer?api_token='+this.$session.get('token')).then((response) => {
...
<style scoped>
.list-kh {position: absolute;width: 100%;left: 0;padding: 15px;}
</style>