...
export default {
    ...
    watch:
    {
        SETTING_DU_AN(val)
        {
            console.log(Object.entries(this.du_an_kh_edit.value_setting).length)
            this.settings = val
            ...
            //     {
            //         for(var i = Object.entries(this.du_an_kh_edit.value_setting).length; i < Object.entries(val).length ; i++)
            //         {
            //              this.du_an_kh_edit.value_setting.push("")
            //         }
            //     }
