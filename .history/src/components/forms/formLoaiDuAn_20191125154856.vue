<template>
 <form @submit.prevent="api_du_an()" class="form-rule" style="padding: 15px;">
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <b-input type="text" v-model="loai_du_an.ten_du_an"  placeholder="Tên loại dự án" required></b-input>
        </div>
    </div>
        <div class="form-group row">
        <label for="inputPassword3" class="col-sm-4 col-form-label" >Mô tả</label>
        <div class="col-sm-8">
            <b-input type="textarea" v-model="loai_du_an.mo_ta_du_an" minlength=""
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <b-input type="text" v-model="loai_du_an.ghi_chu_du_an"  placeholder="Ghi chú"  ></b-input>
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <b-field>
                <b-select v-model="loai_du_an.trang_thai_du_an">
...
export default {
    ...
    methods: {
        api_du_an()
        {
            ...
            loai_du_an.append("P_TEN_DU_AN", this.loai_du_an.ten_du_an);
            loai_du_an.append("P_MO_TA_DU_AN", this.loai_du_an.mo_ta_du_an);
            loai_du_an.append("P_GHI_CHU_DU_AN", this.loai_du_an.ghi_chu_du_an);
            loai_du_an.append("P_TRANG_THAI_DU_AN", this.loai_du_an.trang_thai_du_an);
        ...
        updateLoaiDuAn()
        {
            ...
            loai_du_an.append("P_TRANG_THAI_DU_AN", this.loai_du_an.trang_thai_du_an);
            const app = this;
            this.axios.post(this.$store.state.config.API_URL + 'loai-du-an/'+this.loai_du_an.id_du_an+'?api_token='+this.$session.get('token'),loai_du_an).then((response) => {
                app.loai_du_an = {
                    trang_thai_du_an: 1
                }
