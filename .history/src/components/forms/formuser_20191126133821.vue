    ...
    <form>
        ...
        <div class="form-group row">
            <div class="col-sm-9">
                ...
                <button type="button" :disabled="!update" class="btn btn-warning btn-form" @click="api_update_user()">Cập nhật</button>
...
export default {
    ...
    methods:
    {
        api_resignter_user()
        {
            ...
            const app = this;
            this.axios.post(this.$store.state.config.API_URL + 'user_manager?api_token='+this.$session.get('token'),user).then((response) => {
