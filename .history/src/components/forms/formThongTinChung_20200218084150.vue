<template>
 <form class="form-rule" style="padding: 15px;"  v-if="Object.entries(settings).length > 0 " >
    <divclass="row" v-for="(setting,index) in settings" :key="index" style="margin: 10px 0;">
...
export default {
    ...
    methods: {
        ...
        updateValueSetting()
        {
            ...
            {
                this.$store.dispatch("updateValueSetting",this.du_an_kh_edit.value_setting)
                .then(() => {
