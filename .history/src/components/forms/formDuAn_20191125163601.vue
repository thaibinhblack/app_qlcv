<template>
 <form @submit.prevent="api_du_an()" class="form-rule" style="padding: 15px;">
    <div class="form-group row">
        <label for="inputPassword3" class="col-sm-4 col-form-label" >Loại dự án</label>
        <div class="col-sm-8">
            <b-field>
    ...
    <div class="form-group row">
        <div class="col-sm-9">
            ...
            <button type="button" :disabled="!update" class="btn btn-warning btn-form" @click="updateLoaiDuAn()">Cập nhật 1</button>
...
export default {
    ...
    methods: {
        ...
        api_du_an()
        {
            ...
            data.append("P_ID_LOAI_DA",this.du_an.id_loai_da)
