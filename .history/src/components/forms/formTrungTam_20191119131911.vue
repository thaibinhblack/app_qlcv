...
<form @submit.prevent="api_trung_tam()" style="padding:15px;">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            ...
            v-model="trungtam.mo_ta_tt"   required></b-input>
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            ...
            v-model="trungtam.ghi_chu_tt"  required></b-input>
        </div>
    </div>
    <div class="form-group row">
...
export default {
    ...
    methods: 
    {
        api_trung_tam()
        {
            ...
            this.aixos.post(this.$store.state.config.API_URL + 'trun-tam?api_token='+this.$session.get('token'),trung_tam).then((response) => {
