    ...
    <div class="row">
        <div class="col-sm-12 col-md-6">
            ...
            <div class="form-group row" v-if="parent == true">
                ...
                <div class="col-sm-8">
                    <b-filed>
                        <b-select placeholder="Danh sách loại công việc cha" expanded v-model="selected_parent">
...
export default {
    ...
    methods:
    {
        api_loai_cv()
        {
            ...
            form_loai_cv.append("P_PARENT",this.selected_parent)
            const app = this;
